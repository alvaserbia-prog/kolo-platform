...
/** Globalni frejm (od početka videa) u kom počinje reč — za slojeve koji traju preko više scena. */
export const gk = (id: number, rec: string, pojava = 1): number => scena(id).odF + kad(id, rec, pojava);
