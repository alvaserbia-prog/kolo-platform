"""Vremenski plan videa 03: gde počinje koja scena i gde je koji deo glasa.
...
EXTRA = {2: 0.0, 3: 0.0, 4: 0.45, 5: 0.45, 6: 0.35}  # dodatna tišina pre scene
KRAJ = 45.4         # muzika: završni akord odzvoni (vidi mix.py)
