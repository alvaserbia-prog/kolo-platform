"""Miks (video 03): šest klipova naracije na mestima iz plana + muzika sa duckingom, -14 LUFS.

Glas: iz audio/final/glas.wav seče se [klipOd, klipDo] svake scene i postavlja na glasOd.
Muzika: audio/muzika-slozena.wav (scripts/muzika.py), -8 dB, rez na 2,6 kHz, sidechain vođen glasom.
...
n = len(plan["scene"])
ulazi += ["-i", "audio/muzika-slozena.wav"]
