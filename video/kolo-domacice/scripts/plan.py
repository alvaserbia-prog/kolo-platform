"""Vremenski plan videa „Domaćice“: gde počinje koja scena i gde je koji deo glasa.

Naracija je jedan snimak (audio/final/glas.wav). Seče se na deset klipova u sredini pauze
...
FPS = 30
UVOD = 1.4          # muzika i prvi kadar pre prvog glasa
PRE_SCENE = 0.30    # kadar kreće malo pre glasa
PRE = {6: 1.15, 2: 0.45}  # preokret: slika i muzika kreću pre glasa
EXTRA = {2: 0.35, 3: 0.25, 4: 0.2, 5: 0.35, 6: 1.6, 7: 0.25, 8: 0.2, 9: 0.45, 10: 0.5}  # dodatna tišina pre scene
KRAJ_POSLE_GLASA = 3.6  # završna kartica posle poslednje reči
