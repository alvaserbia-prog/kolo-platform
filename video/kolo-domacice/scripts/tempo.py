"""Zbijanje pauza + blago ubrzanje naracije (video Domaćice, jedan snimak).
...
PRAG_SCENA = 1.0
PRAG_DB = 34
KRAJ_SNIMKA = 102.4  # ceo snimak
# Izbačen deo snimka: pogrešan početak scene 6 („Kolu zimnica ne mora da... moramo ovo ponovo“)
IZBACI = [(50.50, 57.15)]
TEMPO = 1.04
