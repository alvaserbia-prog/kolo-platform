...
export const Glava: React.FC<GlavaCfg & { seed: string }> = ({ seed, r = 46, koza = P.koza, kosa = P.kosaTamna, frizura = "kratka", brkovi, naocare, osmeh = 1, zmurka }) => {
