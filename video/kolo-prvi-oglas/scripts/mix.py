"""Miks (video „Registracija i prvi oglas“): šest klipova naracije na mestima iz plana + muzika sa duckingom, -14 LUFS.

Glas: iz audio/final/glas.wav seče se [klipOd, klipDo] svake scene i postavlja na glasOd.
Muzika: audio/muzika.wav (numera iz videa 2, bez preslaganja), -8 dB, rez na 2,6 kHz, sidechain vođen glasom.
