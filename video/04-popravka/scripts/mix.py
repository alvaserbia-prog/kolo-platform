...
filt.append(f"[{n}:a]aformat=channel_layouts=stereo,volume=-5dB[muz]")
filt.append("[muz][okidac]sidechaincompress=threshold=0.03:ratio=4:attack=35:release=500:makeup=1[muzd]")
