...
*Izmene u verziji 3.7.6: dodata radnja obrade br. 12 (Analitika korišćenja — kolačići trećih lica: Google Analytics i Microsoft Clarity), na osnovu pristanka korisnika. Usklađeno sa Politikom privatnosti v3.7.6 i DPIA v3.7.6.*

*Ovaj registar donosi se na osnovu čl. 47 Zakona o zaštiti podataka o ličnosti („Sl. glasnik RS“, br. 87/2018, u daljem tekstu: ZZPL), čl. 62 i 63 Pravilnika o KOLO sistemu (verzija 3.7.5) i čl. 9 Pravilnika o hijerarhiji akata KOLO sistema. Primenjuje se zajedno sa Politikom privatnosti KOLO platforme (verzija 3.7.6) i Pravilnikom o programima podrške (verzija 3.7.5).*
...
| **Status** | AKTIVNO — Modul 3 se aktivira u skladu sa čl. 57 Pravilnika i Pravilnikom o programima podrške (v3.7.5); aktiviranje je praćeno ažuriranjem DPIA (v3.7.5). |
| --- | --- |
...
**Radnja obrade br. 12 — Analitika korišćenja (kolačići trećih lica)**

| **Svrha obrade** | Merenje i analiza korišćenja Platforme radi poboljšanja sadržaja i upotrebljivosti (statistika poseta, otkrivanje problema u korišćenju). |
| --- | --- |
| **Kategorije lica** | Posetioci i korisnici Platforme koji su dali pristanak na analitičke kolačiće. |
| **Kategorije podataka** | Pseudonimni identifikator iz kolačića, anonimizovana IP adresa, podaci o uređaju i pregledaču, posećene stranice, interakcija sa stranicom (kod Microsoft Clarity: heatmape i pseudonimni snimci interakcije, bez sadržaja unetog u polja). |
| **Pravni osnov** | Pristanak korisnika (čl. 12 st. 1 t. 1 ZZPL-a). Analitika se ne učitava dok korisnik ne da pristanak; pristanak se može odbiti bez posledica i povući u svakom trenutku. |
| **Primaoci / obrađivači** | Google (Google Ireland Limited / Google LLC) — Google Analytics; Microsoft Corporation — Microsoft Clarity. Na osnovu ugovora o obradi. |
| **Prenos u treću zemlju** | Da — obrađivači posluju van Srbije (pretežno SAD); prenos uz standardne ugovorne klauzule i mere iz čl. 9 Politike privatnosti. |
| **Rok čuvanja** | U skladu sa podešavanjima zadržavanja kod obrađivača (Google Analytics: do 14 meseci za podatke na nivou korisnika/događaja; Microsoft Clarity: do 12 meseci), ili do povlačenja pristanka. |
| **Mere zaštite** | Uslovljeno učitavanje uz pristanak (privacy-by-default, baner za kolačiće), anonimizacija IP adrese (`anonymize_ip`), pseudonimna obrada, mogućnost odbijanja i povlačenja pristanka, ugovor o obradi sa svakim obrađivačem. Neophodni (sesijski) kolačići rade nezavisno i nisu obuhvaćeni ovom radnjom. |
