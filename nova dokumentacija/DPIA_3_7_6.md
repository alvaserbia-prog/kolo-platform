...
Datum izrade: 23.05.2026. — Datum poslednje izmene: 03.06.2026.

*Klasifikacija: Interno*

*Izmene u verziji 3.7.6: dodata radnja obrade br. 12 (Analitika korišćenja — kolačići trećih lica: Google Analytics i Microsoft Clarity), zasnovana na pristanku korisnika, sa procenom rizika i merama (uslovljeno učitavanje uz pristanak, anonimizacija IP-a, mogućnost odbijanja/povlačenja). Usklađeno sa Politikom privatnosti v3.7.6 i Registrom radnji obrade v3.7.6.*
...
| **Verzija DPIA** | 3.7.6 |
| **Datum izrade** | 23.05.2026. (poslednja izmena 03.06.2026.) |
| **Predmet procene** | KOLO sistem — Faza 1, aktivne radnje obrade br. 1–10 i br. 12 (uključujući aktivirani Modul 3 — Socijalni programi sa verifikatorskom potvrdom, i analitiku korišćenja zasnovanu na pristanku); neaktivna radnja obrade br. 11 (Modul 4 — Deca) |
| **Povezani dokumenti** | Pravilnik o KOLO sistemu (v3.7.5), Politika privatnosti (v3.7.6), Registar radnji obrade (v3.7.6), Pravilnik o programima podrške (v3.7.5), Pravilnik o hijerarhiji akata (v3.7.2), Statut (v3.7.2), Whitepaper (v3.7.2) |
| **Sledeća revizija** | Pre aktiviranja Modula 4, pri izmeni mehanizma potvrde socijalnih programa, pri promeni analitičkih alata, ili najkasnije 12 meseci od poslednje izmene |
...
Sistem u Fazi 1 obuhvata dvanaest radnji obrade definisanih Registrom radnji obrade (v3.7.6). Radnje 1–10 i 12 su aktivne (Modul 3 — Socijalni programi je aktiviran ovom procenom; radnja 12 — analitika — aktivna je samo uz pristanak korisnika); radnja 11 je neaktivna do aktiviranja Modula 4.
...
| Br. 12 | Analitika korišćenja (kolačići trećih lica — Google Analytics, Microsoft Clarity) | Pristanak korisnika (čl. 12 st. 1 t. 1) | Aktivno (samo uz pristanak) |

Detaljne kategorije podataka, kategorije lica, primaoci, rokovi čuvanja i mere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v3.7.6) koji se primenjuje zajedno sa ovom procenom.
...
Hosting provajder (Vercel) i provajder baze podataka (Neon) koji održavaju infrastrukturu Protokola su obrađivači podataka u smislu čl. 45 ZZPL-a, na osnovu ugovora o obradi. Email servis (Resend) je obrađivač za dostavu sistemskih obaveštenja. Analitički alati trećih lica (Google Analytics, Microsoft Clarity) obrađuju podatke o korišćenju **isključivo uz pristanak korisnika** (radnja br. 12). Bankovna dokumentacija donacija ostaje kod Fondacije i, po potrebi, kod revizora. Pojedini obrađivači posluju van Republike Srbije (pretežno SAD), pa se prekogranični prenos podataka uređuje u skladu sa čl. 65–69 ZZPL-a i čl. 9 Politike privatnosti (standardne ugovorne klauzule / odgovarajuće mere zaštite).
...
## 3.2. Radnje zasnovane na pristanku (br. 3, 9, 12)

Dobrovoljno uneti podaci (ime, prezime, telefon) su fakultativni — korisnik ih unosi samo ako želi. Tabla zahteva za jemstvo zahteva zaseban pristanak za svaku objavu, sa eksplicitnim upozorenjem o krugu lica koja će videti podatke. Pristanak je dobrovoljan, može se povući u svakom trenutku bez posledica po status, i ima automatski istek od 30 dana.

Analitika korišćenja (br. 12) — kolačići trećih lica (Google Analytics, Microsoft Clarity) ne učitavaju se dok korisnik ne da pristanak putem banera za kolačiće; analitika nije neophodna za korišćenje Platforme i njeno odbijanje nema posledica. Pristanak se može povući. Obrada je srazmerna jer je IP adresa anonimizovana, a snimci interakcije (Clarity) su pseudonimni i služe samo otkrivanju problema u korišćenju. Zaključak: obrade su zasnovane na slobodnom pristanku i srazmerne su svrsi.
...
## 5.7. Mere za analitiku korišćenja (radnja br. 12)

Uslovljeno učitavanje uz pristanak — analitički kolačići trećih lica (Google Analytics, Microsoft Clarity) ne učitavaju se i ne postavljaju nijedan kolačić dok korisnik ne da izričit pristanak putem banera za kolačiće pri prvoj poseti (privacy-by-default). Slobodno odbijanje i povlačenje — korisnik može odbiti analitiku bez ikakvih posledica po korišćenje Platforme, a dati pristanak povući u svakom trenutku. Minimizacija — IP adresa u Google Analytics je anonimizovana (`anonymize_ip`); Microsoft Clarity snima interakciju u pseudonimnom obliku radi otkrivanja problema u korišćenju, bez prikupljanja podataka iz polja za unos. Alternativa bez kolačića — za osnovne agregatne pokazatelje koristi se i analitika bez kolačića (Vercel Analytics) koja ne omogućava identifikaciju pojedinca. Prekogranični prenos — obrađivači (Google, Microsoft) posluju van Srbije; prenos je pokriven merama iz čl. 9 Politike privatnosti (standardne ugovorne klauzule). Ugovori o obradi — sa svakim analitičkim obrađivačem zaključuje se ugovor o obradi podataka.
