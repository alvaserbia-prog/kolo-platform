...
The KOLO Foundation is a non-profit private legal entity registered in the Republic of Serbia, registration number [REGISTRATION NUMBER], tax identification number [TAX ID], with its registered address at Šetalište 16, 25000 Sombor.
...
The KOLO system is in Phase 1 within the meaning of the Rulebook. In this phase, system governance is exercised by the founder and the Foundation.
...
The user may have one active request on the board. An active request loses that property upon withdrawal by the user, automatic expiry of the 30-day period from publication, completion of user verification, or removal by the Foundation.
