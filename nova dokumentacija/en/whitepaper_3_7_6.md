...
| --- | --- | --- |
| Unverified user | Registered, reality unconfirmed | System overview, preparation for verification |
...
**Unverified user —** A person registered on the platform whose reality has not been confirmed through the vouching chain. Can view the system and prepare for verification. Has no access to exchange, contribution recording, or donating. Entry-level status. Chapter 7.
...
**Sponsorship —** A donation of goods, services, or money by a legal entity. The ledger entry is linked to the ultimate beneficial owner. The only point in the system where the external economy directly affects the internal ledger. Chapter 8.2.
