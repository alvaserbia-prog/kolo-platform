...
Date of preparation: 23.05.2026. — Date of last amendment: 02.06.2026.
...
| **Email for data protection** | privatnost@kolo.rs |
| **Data Protection Officer (DPO)** | [FULL NAME], [DPO EMAIL] |
| **DPIA version** | 3.7.5 |
| **Date of preparation** | 23.05.2026. (last amended 02.06.2026.) |
| **Subject of assessment** | KOLO system — Phase 1, active processing activities no. 1–10 (including the activated Module 3 — Social Programs with verifier confirmation); inactive processing activity no. 11 (Module 4 — Children) |
| **Related documents** | Rulebook on the KOLO System (v3.7.5), Privacy Policy (v3.7.4), Records of Processing Activities (v3.7.5), Rulebook on Support Programs (v3.7.5), Rulebook on the Hierarchy of Acts (v3.7.2), Statute (v3.7.2), Whitepaper (v3.7.2) |
...
The system in Phase 1 encompasses eleven processing activities defined by the Records of Processing Activities (v3.7.5). Activities 1–10 are active (Module 3 — Social Programs is activated by this assessment); activity 11 is inactive until the activation of Module 4.
...
Detailed categories of data, categories of data subjects, recipients, retention periods, and protection measures for each processing activity are established by the Records of Processing Activities (v3.7.5) applied together with this assessment.
...
## 3.4. Processing Activities Based on Legitimate Interest (no. 6, 7)
...
Eleven risks to the rights and freedoms of data subjects have been identified. No risk has been assessed as high. Five risks are at the medium level (R1, R2, R5, R8, R11), and six at the low level (R3, R4, R6, R7, R9, R10).
