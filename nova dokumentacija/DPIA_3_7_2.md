...
| **Povezani dokumenti** | Pravilnik o KOLO sistemu (v3.7.2), Politika privatnosti (v3.7.2), Registar radnji obrade (v3.7.2), Pravilnik o hijerarhiji akata (v3.7.2), Statut (v3.7.2), Whitepaper (v3.7.2) |
...
Sistem u Fazi 1 obuhvata jedanaest radnji obrade definisanih Registrom radnji obrade (v3.7.2). Radnje 1–9 su aktivne; radnje 10–11 su neaktivne do aktiviranja Modula 3 i 4.
...
Detaljne kategorije podataka, kategorije lica, primaoci, rokovi čuvanja i mere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v3.7.2) koji se primenjuje zajedno sa ovom procenom.
