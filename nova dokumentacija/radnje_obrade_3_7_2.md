...
Datum poslednje izmene: 23.05.2026.

*Ovaj registar donosi se na osnovu čl. 47 Zakona o zaštiti podataka o ličnosti („Sl. glasnik RS“, br. 87/2018, u daljem tekstu: ZZPL), čl. 62 i 63 Pravilnika o KOLO sistemu (verzija 3.7.2) i čl. 9 Pravilnika o hijerarhiji akata KOLO sistema. Primenjuje se zajedno sa Politikom privatnosti KOLO platforme (verzija 3.7.2).*
...
| **Svrha obrade** | Omogućavanje uspostavljanja kontakta između neverifikovanog korisnika i potencijalnih verifikatora radi sprovođenja verifikacije u fizičkom prisustvu. |
| --- | --- |
...
| **Status** | NEAKTIVNO — aktivira se po pokretanju Modula 3 u skladu sa čl. 57 Pravilnika. Aktiviranje zahteva prethodno ažuriranje DPIA. |
| --- | --- |
| **Svrha obrade** | Automatsko evidentiranje doprinosa u POEN-ima za korisnike koji pripadaju kvalifikovanim grupama. |
| **Kategorije lica** | Korisnici koji pripadaju kvalifikovanim grupama (roditelji, starija lica, osobe sa invaliditetom, studenti). |
| **Kategorije podataka** | Status roditelja, starosna dob, invaliditet, studentski status ili pripadnost drugoj kvalifikovanoj grupi, datum verifikacije statusa. Fondacija ne čuva kopije podnesene dokumentacije — u sistemu ostaje samo minimalni zapis o pripadnosti grupi. |
| **Pravni osnov** | Izričit pristanak korisnika (čl. 17 st. 2 t. 1 ZZPL-a). Pristanak se može povući u svakom trenutku, sa posledicom prestanka automatskog evidentiranja. |
| **Primaoci / obrađivači** | [Hosting provajder / naziv obrađivača]. |
| **Prenos u treću zemlju** | [Da/Ne] |
| **Rok čuvanja** | Do povlačenja pristanka od strane korisnika. |
| **Mere zaštite** | Podaci se čuvaju odvojeno od opšte evidencije aktivnosti, zaštićeni dodatnim nivoom enkripcije, pristup ograničen na proces verifikacije. |
