...
export const FAQ_SEKCIJE_EN: FaqSekcija[] = [
  {
    id: "pocetnici",
    naslov: "Getting Started",
    pitanja: [
      {
        id: 42,
...
Citizenship is not a requirement — what matters is that you are a real person.`,
      ...
      {
        id: 78,
        pitanje: `Where are the servers located, and does my data cross the border of Serbia?`,
        odgovor: `The platform is hosted with reputable infrastructure providers whose servers are located in the European Union and the United States of America. This means your data may be processed outside Serbia.

Such a transfer is permitted and regulated under personal data protection law. The Foundation puts in place appropriate safeguards — standard contractual clauses or another legal basis guaranteeing a level of protection comparable to the domestic standard — and selects providers with attention to server location and the legal framework of their jurisdiction.
