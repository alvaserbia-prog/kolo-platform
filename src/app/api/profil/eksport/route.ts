  ...
  const [
    ...
    prisma.transaction.findMany({
      ...
      select: {
        ...
        description: true,
        createdAt: true,
        fromWallet: { select: { userId: true, zadrugaId: true } },
        toWallet: { select: { userId: true, zadrugaId: true } },
      },
