...
export default async function AdminPage() {
  ...
  const [
    ...
    prisma.user.findMany({
      select: { id: true, pseudonim: true, email: true, role: true, tipKorisnika: true, verified: true, status: true, suspendedReason: true, createdAt: true, wallet: { select: { balance: true } } },
  ...
  return (
    <AdminKlijent
      ...
      users={allUsers.map((u) => ({
        id: u.id, pseudonim: u.pseudonim, email: u.email, role: u.role, tipKorisnika: u.tipKorisnika, verified: u.verified,
