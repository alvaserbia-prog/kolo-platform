...
export const ADMIN_TABOVI = ["dashboard", "programi", "ped", "pokrovitelji", "donacije", "prigovori", "korisnici", "emisija", "osnivaci", "vesti", "obavestenja", "audit", "aktivnost", "nadzor"] as const;
