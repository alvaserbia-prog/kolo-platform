        ...
        <div className="mb-6 rounded-xl border border-kolo-green-700/30 bg-kolo-green-100 px-4 py-4">
          ...
          <div className="mt-3 space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-kolo-border bg-white text-sm font-medium text-kolo-text hover:bg-kolo-bg transition-colors"
            >
