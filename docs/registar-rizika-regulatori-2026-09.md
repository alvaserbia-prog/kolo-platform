...
| **R-08** | **Strukturna hiperinflacija POEN-a uz objavljen odnos 1:1** — dnevni limit je 10% opticaja koji sam raste tim emisijama; socijalni programi bez gornje granice; osnivački kanal se prazni u nedeljama | Zaštita potrošača / sistemski | **8** | 🟢 **umanjeno 16.09.2026.** (set 4.6.4) — ocena se preračunava pri obradi |
...
| **R-16** | **Čitanje osnivačkog kanala kao lančane šeme** — rast koji finansiraju novi učesnici automatski puni zatvoren krug koji je ušao prvi | Zaštita potrošača | **7** | 🟢 **umanjeno 16.09.2026.** (set 4.6.4) — ocena se preračunava pri obradi |
