...
| **M-12** | brana `__tests__/pdv-fiskalizacija-izvor.test.ts` + odredbe u `pravni-dokumenti.test.ts` (sr/en/ru) | — |

**Set 4.6.1** — Uslovi korišćenja (sa 4.5.9), Pravilnik o projektima i kolektivnim
