...
Egyetlen felhasználónak vagy kollektív formának sem lehet negatív POEN-bejegyzése.
...
5) szociális programok;

6) alapítói hozzájárulás;

7) a platformon zajló cseréhez való hozzájárulás.

Az 1., 3., 4., 6. és 7. pont szerinti csatornákat e szabályzat VI. fejezete rendezi. A 2. pont szerinti csatornát a valóságbizonyítékról szóló szabályzat rendezi. Az 5. pont szerinti csatornát a VIII. fejezet rendezi a rendszer moduljaként. Az egyes csatornákra vonatkozó nyilvántartásba vételi paramétereket, feltételeket és korlátozásokat külön szabályzatok állapítják meg, különösen a működési hozzájárulásról szóló szabályzat, a valóságbizonyítékról szóló szabályzat, az adományokról szóló szabályzat, a pártfogásról szóló szabályzat, a Támogatási Programok szabályzatai és az alapítói hozzájárulásról szóló szabályzat.

A kollektív formák növekedése nem hozzájárulás-nyilvántartási csatorna. A kollektív formák modulja nincs aktiválva, így a Protokoll ezen az alapon nem ír be új POEN-bejegyzéseket; ilyen csatorna bevezetése e cikk módosítását igényli a 80. cikk szerinti eljárásban.
...
A nem hitelesített felhasználó hozzájárulása kizárólag a platformon zajló cseréhez való hozzájárulás csatornáján keresztül vehető nyilvántartásba (15. cikk 7. pont és 40.a cikk). A többi csatornán keresztül hozzájárulása nem kerül nyilvántartásba, és ZRNO-t sem írhat be.
...
A kezességi láncban tett megerősítések összessége alkotja a hitelesítési gráfot. A hitelesítési gráf személyes adatok nyilvántartása; azon az infrastruktúrán vezetendő, amelyen a Protokoll működik, adattakarékosság mellett.
...
A felhasználó POEN-bejegyzései megsemmisítésre kerülnek, a Protokoll megfelelő ellenbejegyzése pedig ugyanazzal az összeggel csökken. A zéró összegű invariáns fennmarad.
...
*A platformon zajló cseréhez való hozzájárulás*

A javak és szolgáltatások cseréje a platform hirdetési terének rendeltetése. Ez a tér hirdetések nélkül nem tölti be rendeltetését: a csere nem keletkezik magától, hanem csak akkor, ha valaki elsőként kimondja, mit kínál vagy mit keres. Az a felhasználó, aki ezt megteszi, lehetővé teszi a cserét, és ezzel hozzájárul a közjóhoz. Az eközben keletkező tartalom a közjó része, és e szabályzat 7. cikkével összhangban kerül licencelésre.

A felhasználó javára egyszeri alkalommal 1.000 POEN összegű hozzájárulás kerül nyilvántartásba az első olyan hirdetésért, amellyel javat vagy szolgáltatást kínál vagy keres, és amely megfelel a Felhasználási feltételekben megállapított tartalmi minimumnak. A csatorna felhasználónként legfeljebb egyszer vehető igénybe, a közzétett hirdetések számától és fajtájától függetlenül.

A nem hitelesített felhasználó kizárólag olyan hirdetést tehet közzé, amellyel javat vagy szolgáltatást kínál (16. cikk 5. bekezdés), így az ő javára a hozzájárulás csak ezen az alapon kerül nyilvántartásba.
...
A platformon zajló cseréhez való hozzájárulás nyilvántartásba vétele a Protokoll automatikus aktusa, és nem számít bele a működési hozzájárulásról szóló szabályzatban és a Támogatási Programok szabályzataiban megállapított napi korlátba.
...
A Körnek nincs növekedési mechanizmusa: a Protokoll a kör tagjainak száma és a küszöbök elérése alapján nem ír be új POEN-bejegyzéseket. Ilyen mechanizmus bevezetése a 15. cikkben megállapított nyilvántartási csatornát igényelne, amelyet a kollektív formák számára a szabályzat nem ír elő.
...
A Szövetkezetnek a rendszeren belül a helyi koordináció a funkciója — az a szerkezet, amelyen keresztül az általa lefedett területen zajlik a csere, a kommunikáció és a tevékenységek szervezése. A Körhöz hasonlóan a szövetkezetnek sincs növekedési mechanizmusa: a felhasználói létszámküszöbök elérése nem kerül POEN-ben nyilvántartásba.
