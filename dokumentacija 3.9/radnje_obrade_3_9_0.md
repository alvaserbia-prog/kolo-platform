...
| **Status** | AKTIVNO — Modul 3 se aktivira u skladu sa čl. 57 Pravilnika i Pravilnikom o programima podrške (v3.9.0); aktiviranje je praćeno ažuriranjem DPIA (v3.9.0). |
| --- | --- |
