...
Platforma obezbeđuje tehnički mehanizam saglasnosti i vezivanja naloga: verifikovani korisnik generiše jednokratan kod kojim pristaje na verifikaciju i vezuje svoj nalog za taj čin. Taj mehanizam ne prikuplja lične podatke verifikovanog i ne predstavlja dokaz prisustva, već potvrdu saglasnosti verifikovanog i identiteta naloga.

Saglasnost i vezivanje naloga mogu se izraziti i objavom zahteva na tabli zahteva za jemstvo: objavljivanjem zahteva korisnik pristaje da bude verifikovan i vezuje svoj nalog za taj zahtev, pa verifikator koji ga poznaje verifikaciju pokreće neposredno sa objavljenog zahteva. U tom slučaju ne generiše se jednokratan kod — objavljeni zahtev ima istu ulogu potvrde saglasnosti i identiteta naloga. Korisnik koji je verifikovan obaveštava se o sprovedenoj verifikaciji i može je prijaviti ako ne poznaje verifikatora. Ovaj način pokretanja ne menja prirodu, uslove ni provere verifikacije: anti-cirkularno pravilo (Glava V), verifikacioni kapacitet i nadzor (Glava IV) primenjuju se nepromenjeno.
...
*Pravilnik o dokazu stvarnosti v3.9.1*
