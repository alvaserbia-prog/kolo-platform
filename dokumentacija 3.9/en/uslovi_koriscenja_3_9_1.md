...
*Date of entry into force: 16.06.2026. (amendment 3.9.1: 25.06.2026.)*
...
The KOLO Foundation is a non-profit private legal entity in the process of registration in the Republic of Serbia (the registration number and tax identification number will be entered upon completion of registration), with its registered address at Šetalište 16, 25000 Sombor.
...
Certain functionalities provided for by the Rulebook are activated as modules according to their own prerequisites and are not operational at the time these Terms enter into force. These include collective forms (Circles and cooperatives), social programs, the Children Module, and internationalization.
...
An unverified user may view general system indicators, familiarize themselves with the rules, access the guarantee board in accordance with Article 16 of these Terms, and view the amounts and timestamps of POEN transactions without the parties' pseudonyms and without access to account balances.

An unverified user may view listings in the exchange space, but may not post listings, access advertisers' contact details, or independently initiate communication via the Platform. Communication by an unverified user is possible exclusively within the guarantee board mechanism (Article 16): an unverified user may respond in a conversation that a verified user has initiated regarding their published request, but may not initiate a conversation themselves or contact users who have not contacted them. An unverified user may not verify other users, nor have contributions recorded in POENs. They may exchange goods and services outside the exchange space and participate in POEN ledger updates — as a giver or a receiver (in accordance with Art. 28 of the Rulebook on the KOLO System).
...
### Article 16 — Guarantee Board

The guarantee board enables an unverified user to present themselves to the network of verified users for the purpose of establishing contact necessary for verification. The existence of the board does not change the nature, procedure, or conditions of verification established by the Rulebook and the Rulebook on Proof of Reality.

By publishing a request, the user enters a presentation text and contact details of their own choice. The presentation text is accessible to all registered Platform users. Contact details are accessible exclusively to verified users and are displayed only upon explicit disclosure, which is logged in the access log. The data are not accessible to non-registered persons and are not indexed by search engines.

A verified user may, starting from an active request, initiate a direct conversation (messages) with the user who published the request. In such an initiated conversation, the user who published the request may respond even before being verified. An unverified user may not initiate a conversation themselves, nor contact users who have not contacted them regarding their request. The initiation of the conversation is logged in the access log, and the processing of data in the conversation is governed by the Platform's Privacy Policy. This possibility does not change the nature, procedure, or conditions of verification.

A verified user who has the right to verify may, starting from an active request, verify the user who published the request if they know them personally. By publishing a request on the board, the user consents to being verified in this manner; a separate one-time code is then not required. Verification is carried out under the same conditions and checks established by the Rulebook on Proof of Reality (including the anti-circular rule, capacity, and oversight). The user who is verified is notified of the completed verification and may report it to the Foundation if they do not know the verifier.

The user may have one active request on the board. An active request loses that property upon withdrawal by the user, automatic expiry of the 72-hour period from publication, completion of user verification, or removal by the Foundation. After expiry, the user may publish a new request.

The Foundation may remove a request that contains offensive, discriminatory, or unlawful content, false data, or content unrelated to the purpose of the board. The Foundation notifies the user of the removal and states the reason.

The processing of data within the board is governed by the Platform's Privacy Policy.
...
Verified users and ZRNO Holders have full access to the pseudonyms of all users, account balances, and all transactions with the pseudonyms of parties.
...
Browsing listings in the exchange space — the content of an offer or request, price, location, and the advertiser's pseudonym — is public and accessible to all visitors. Posting listings, accessing the advertiser's contact details, and communicating regarding listings are available exclusively to verified users and ZRNO Holders. For non-registered and unverified persons, the advertiser's pseudonym in the exchange space is not linked to the contribution ledger or the user's profile.
...
The user is responsible for all content they publish on the Platform, including offers, requests, texts on the guarantee board, and all other communications via the Platform.
