...
| **Status** | ACTIVE — Module 3 is activated in accordance with Art. 57 of the Rulebook and the Rulebook on Support Programmes (v3.9.0); activation is accompanied by an updated DPIA (v3.9.0). |
| --- | --- |
