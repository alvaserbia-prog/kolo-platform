...
| **Related documents** | Rulebook on the KOLO System (v3.9.0), Privacy Policy (v3.9.0), Records of Processing Activities (v3.9.0), Rulebook on Support Programmes (v3.9.0), Rulebook on the Hierarchy of Acts (v3.9.0), Statute (v3.9.0), Whitepaper (v3.9.0) |
...
Detailed categories of data, categories of data subjects, recipients, retention periods, and protection measures for each processing activity are established by the Records of Processing Activities (v3.9.0) applied together with this assessment.
