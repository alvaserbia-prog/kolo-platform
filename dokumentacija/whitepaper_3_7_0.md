...
Finansijski doprinos je dinarski priliv u fondaciju koji obezbeđuje operativnu održivost sistema. Ovaj odeljak obuhvata dva podmodula: donacije fizičkih lica i pokroviteljstvo pravnih lica. Oba koriste isti princip — nepovratna donacija fondaciji čiji se doprinos evidentira u POEN-ima kao jednostrani administrativni zapis protokola. Razlika je u pravnoj prirodi donatora i u regulatornim obavezama koje iz toga proizlaze.
...
### Pokroviteljstvo pravnih lica

Pokrovitelji su pravna lica koja doniraju robu, usluge ili novac sistemu. Ovaj podmodul je most između spoljne ekonomije i KOLO sistema.

Mehanika je sledeća: pravno lice daje realne resurse — robu, usluge ili dinarska sredstva — fondaciji, koja ih koristi za programe sistema ili ih distribuira korisnicima. Doprinos krajnjeg stvarnog vlasnika tog pravnog lica — fizičkog lica koje je verifikovani korisnik sistema — evidentira se u POEN-ima kao jednostrani administrativni zapis protokola, po pravilima koja definišu odnos između vrednosti pokroviteljstva i broja evidentiranih POEN-a.
...
| **Status** | **Opis** | **Pristup** |
| --- | --- | --- |
| Neverifikovani korisnik | Registrovan, stvarnost nepotvrđena | Pregled sistema, priprema za verifikaciju |
...
| --- | --- | --- |
| Zaštitni veto fondacije | Aktivan do gašenja | Odbija odluku koja narušava principe, krši zakon ili ugrožava fondaciju |
...
**Neverifikovani korisnik — **Lice registrovano na platformi čija stvarnost nije potvrđena kroz lanac jemstva. Može da pregleda sistem i priprema se za verifikaciju. Nema pristup razmeni, evidenciji doprinosa ni doniranju. Ulazni status. Poglavlje 7.
...
**Pokroviteljstvo — **Donacija robe, usluga ili novca od strane pravnog lica. Evidencija se vezuje za krajnjeg stvarnog vlasnika (beneficial owner). Jedina tačka u sistemu gde spoljna ekonomija direktno utiče na internu evidenciju. Poglavlje 8.2.
...
**Zaštitni veto — **Pravo fondacije da odbije odluku koja narušava četiri principa, krši zakon ili ugrožava fondaciju. Mora biti obrazložen. Gasi se trajno i jednosmerno kada finansijska sredstva fondacije dostignu prag finansijske samostalnosti utvrđen posebnim pravilnikom. Poglavlje 10.
...
*KOLO: *Korisnici mogu da podnose primedbe i žalbe na funkcionisanje sistema fondaciji (u obe faze) i Gornjem Kolu (u Fazi 2). Proces odlučivanja u Gornjem Kolu uključuje period javne rasprave u kome cela zajednica može da komentariše i osporava predloge pre glasanja (poglavlje 10). Zaštitni veto fondacije štiti od odluka koje bi narušile principe sistema ili prekršile zakon. Korisnik koji se ne slaže sa odlukama zadržava pravo izlaska iz sistema sa ostvarivanjem prava iz poglavlja 12 (up. Hirschman, 1970). Konkretne procedure za podnošenje primedbi i rešavanje sporova definisane su u pravilniku sistema.
