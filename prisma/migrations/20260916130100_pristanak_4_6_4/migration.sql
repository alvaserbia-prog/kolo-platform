-- Pristanak na akte 4.6.4.
--
-- Set 4.6.4 menja KADA član dobija POEN po potvrdi: 1.000 verifikatoru i 1.000
...
VALUES (gen_random_uuid()::text, '4.6.4', 'Akti KOLO sistema 4.6.4', NOW(), 'migracija-4.6.4', NOW())
