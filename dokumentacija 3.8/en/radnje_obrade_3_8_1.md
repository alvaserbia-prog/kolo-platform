...
*These Records are adopted on the basis of Art. 47 of the Law on Personal Data Protection ("Official Gazette of the RS", no. 87/2018, hereinafter: LPDP), Art. 62 and 63 of the Rulebook on the KOLO System (version 3.8.0), and Art. 9 of the Rulebook on the Hierarchy of Acts of the KOLO System. They are applied together with the Privacy Policy of the KOLO Platform (version 3.8.1) and the Rulebook on Support Programmes (version 3.8.0).*
...
| **Data Protection Officer** | [FULL NAME], [DPO EMAIL] |
...
| **Recipients / processors** | [Hosting provider / name of processor], on the basis of a processing agreement in accordance with the law. |
| **Transfer to a third country** | [Yes/No — align with Art. 9 of the Privacy Policy] |
...
| **Recipients / processors** | [Hosting provider / name of processor]. |
...
| **Categories of data** | Name and surname, telephone number, address, other contact data. |
...
| **Recipients / processors** | [Hosting provider / name of processor]. Data that the user chooses to make visible (name, surname, telephone) are accessible to verified Platform users. |
| **Transfer to a third country** | [Yes/No] |
...
| **Recipients / processors** | [Hosting provider / name of processor]. The ledger is public in pseudonymous form — verified users may view amounts, timestamps, and the pseudonyms of parties. |
| **Transfer to a third country** | [Yes/No] |
...
| **Status** | ACTIVE — Module 3 is activated in accordance with Art. 57 of the Rulebook and the Rulebook on Support Programmes (v3.8.0); activation is accompanied by an updated DPIA (v3.8.0). |
| --- | --- |
...
| **Categories of data** | Parental status, age, disability (disability decision of the competent authority — not medical documentation or diagnosis), student status or belonging to another qualifying group, date of status verification. The Foundation does not retain copies of submitted documentation — only the minimum record of group membership remains in the system. In the confirmation procedure, verifiers are disclosed the fact that the applicant (pseudonym) has applied for a specific program — which may indicate special-category membership — but not the content of the entered data. |
...
| **Recipients / processors** | Exclusively superadministrators (Management Board of the Foundation). The alert channel (Telegram, email/Resend) receives only aggregate numbers, without personal data. [Hosting provider.] |
| **Transfer to a third country** | [Yes/No — align with Art. 9 of the Privacy Policy; Telegram/Resend are foreign processors.] |
