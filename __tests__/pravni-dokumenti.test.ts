 ...
 * (`Pravilnik_4_3_1.md`, `uslovi_koriscenja_4_3_1.md`). Pri podizanju verzije lako je
...
const AKTI = [
  ...
  "Pravilnik_4_3_1.md",
  "dokaz_stvarnosti_4_3_1.md",
  "DPIA_4_3_1.md",
  "radnje_obrade_4_3_1.md",
  "uslovi_koriscenja_4_3_1.md",
  "politika_4_3_1.md",
  "statut_4_1_0.md",
  "whitepaper_4_3_1.md",
  "rizici_4_3_1.md",
  "hijerarhija_4_3_1.md",
  "donacije_4_3_1.md",
  "operativni_4_3_1.md",
  "osnivacki_4_3_1.md",
  "gornje_kolo_4_3_1.md",
  "programi_podrske_4_3_1.md",
  // Usvojen 4.3.0 — do tada nacrt u `docs/pravilnik-modul-deca.md`.
  "ucesce_dece_4_3_1.md",
];
...
describe("kanonski set akata 4.3.1", () => {
  ...
  it("zabranjena zona se više ne opisuje kao trajna", async () => {
    ...
    for (const jez of JEZICI) {
      const tekst = await ucitajPravniDokument("dokaz_stvarnosti_4_3_1.md", jez);
  ...
  it("razmena se ne označava — akti to izričito kažu", async () => {
    ...
    for (const jez of JEZICI) {
      const tekst = await ucitajPravniDokument("Pravilnik_4_3_1.md", jez);
