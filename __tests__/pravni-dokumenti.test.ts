 ...
 * (`Pravilnik_4_3_2.md`, `uslovi_koriscenja_4_3_2.md`). Pri podizanju verzije lako je
...
const AKTI = [
  ...
  "Pravilnik_4_3_2.md",
  "dokaz_stvarnosti_4_3_2.md",
  "DPIA_4_3_2.md",
  "radnje_obrade_4_3_2.md",
  "uslovi_koriscenja_4_3_2.md",
  "politika_4_3_2.md",
  "statut_4_1_0.md",
  "whitepaper_4_3_2.md",
  "rizici_4_3_2.md",
  "hijerarhija_4_3_2.md",
  "donacije_4_3_2.md",
  "operativni_4_3_2.md",
  "osnivacki_4_3_2.md",
  "gornje_kolo_4_3_2.md",
  "programi_podrske_4_3_2.md",
  // Usvojen 4.3.0 — do tada nacrt u `docs/pravilnik-modul-deca.md`.
  "ucesce_dece_4_3_2.md",
];
...
const UVEDENO: Record<string, Record<string, string[]>> = {
  ...
  // 4.3.2 — prag za socijalni program je funkcionalnih 10% (jedna primljena
...
describe("kanonski set akata 4.3.2", () => {
  ...
  it("zabranjena zona se više ne opisuje kao trajna", async () => {
    ...
    for (const jez of JEZICI) {
      const tekst = await ucitajPravniDokument("dokaz_stvarnosti_4_3_2.md", jez);
  ...
  it("razmena se ne označava — akti to izričito kažu", async () => {
    ...
    for (const jez of JEZICI) {
      const tekst = await ucitajPravniDokument("Pravilnik_4_3_2.md", jez);
