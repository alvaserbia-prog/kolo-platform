...
function dete(o: Partial<Ucesnik> = {}): Ucesnik {
  return { id: "d1", maloletan: true, godine: 16, dozvolaOdrasli: false, roditeljIds: ["r1"], skolaSifra: null, stanje: "AKTIVNO", ...o };
}
function odrastao(o: Partial<Ucesnik> = {}): Ucesnik {
  return { id: "o1", maloletan: false, godine: null, dozvolaOdrasli: false, roditeljIds: [], skolaSifra: null, stanje: "AKTIVNO", ...o };
}
