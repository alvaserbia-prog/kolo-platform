...
*Ovaj registar donosi se na osnovu čl. 47 Zakona o zaštiti podataka o ličnosti („Sl. glasnik RS“, br. 87/2018, u daljem tekstu: ZZPL), čl. 62 i 63 Pravilnika o KOLO sistemu (verzija 4.2.1) i čl. 9 Pravilnika o hijerarhiji akata KOLO sistema. Primenjuje se zajedno sa Politikom privatnosti KOLO platforme (verzija 4.2.1) i Pravilnikom o programima podrške (verzija 4.2.1).*
...
| **Status** | AKTIVNO — Modul 3 se aktivira u skladu sa čl. 57 Pravilnika i Pravilnikom o programima podrške (v4.2.1); aktiviranje je praćeno ažuriranjem DPIA (v4.2.1). |
| --- | --- |
...
| **Svrha obrade** | Utvrđivanje ispunjenosti uslova za evidentiranje doprinosa kroz kanal doprinosa sadržaju platforme, koji se od verzije 4.2.1 evidentira kroz putanju od pet koraka (Pravilnik o KOLO sistemu 4.2.1, čl. 15 t. 8 i čl. 40b). Sporedna svrha: sprečavanje da se doprinos ostvari bez stvarne razmene. |
| --- | --- |
