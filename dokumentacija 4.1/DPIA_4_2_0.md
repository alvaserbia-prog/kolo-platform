...
| **Povezani dokumenti** | Pravilnik o KOLO sistemu (v4.2.0), Politika privatnosti (v4.1.1), Registar radnji obrade (v4.2.0), Pravilnik o programima podrške (v4.1.1), Pravilnik o hijerarhiji akata (v4.1.1), Statut (v4.1), Whitepaper (v4.1.1) |
...
Sistem u Fazi 1 obuhvata četrnaest radnji obrade definisanih Registrom radnji obrade (v4.2.0). Radnje 1–10 i 12–14 su aktivne (Modul 3 — Socijalni programi je aktiviran ovom procenom, radnja 13 obuhvata javnu listu donacija, a radnja 14 nadzorni predmet uveden Pravilnikom o dokazu stvarnosti 4.2.0); radnja 11 je neaktivna do aktiviranja Modula 4.
...
Detaljne kategorije podataka, kategorije lica, primaoci, rokovi čuvanja i mere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v4.2.0) koji se primenjuje zajedno sa ovom procenom.
...
Nakon primene svih navedenih mera, rezidualni rizik se ocenjuje kao prihvatljiv. Najviši rezidualni rizici su R1 (neovlašćen pristup), R2 (reidentifikacija), R8 (prekogranični prenos) i R11 (otkrivanje pripadnosti posebnoj kategoriji verifikatorima), svi na srednjem nivou (5–8). Rizik R5 (javna vidljivost oglasa) ukidanjem table i sužavanjem obrade pada na nizak nivo (4). Ovi rizici se dodatno umanjuju kontinuiranim nadzorom, redovnim testiranjem i ažuriranjem mera.
...
Modul 3 se aktivira ovom procenom, u skladu sa čl. 57 Pravilnika i Pravilnikom o programima podrške (v4.1.1). Sistem uvodi obradu posebnih kategorija podataka — status roditelja, starosna dob, invaliditet (rešenje nadležnog organa — ne dijagnoza), studentski status (čl. 17 ZZPL-a). Pravni osnov je izričit pristanak korisnika (čl. 17 st. 2 t. 1 ZZPL-a). Fondacija ne čuva kopije podnesene dokumentacije — ostaje samo minimalni zapis o pripadnosti grupi i datum verifikacije.
