...
| **Povezani dokumenti** | Pravilnik o KOLO sistemu (v4.5.2), Politika privatnosti (v4.5.2), Registar radnji obrade (v4.5.2), Pravilnik o programima podrške (v4.5.0), Pravilnik o hijerarhiji akata (v4.4.6), Statut (v4.1), Whitepaper (v4.4.6) |
...
Sistem u Fazi 1 obuhvata sedamnaest radnji obrade definisanih Registrom radnji obrade (v4.5.2). Sve radnje su aktivne. Radnja 17 obuhvata privatnu komunikaciju između korisnika, koja je do tog registra bila obrađivana a nije bila zasebno popisana. Radnja 16 obuhvata predlog za nabavku i učešće u kolektivnoj nabavci, uvedene članovima 14a i 51a Pravilnika o KOLO sistemu. Modul 3 (Socijalni programi) aktiviran je ranijom verzijom ove procene; radnja 13 obuhvata javnu listu donacija, radnja 14 nadzorni predmet uveden Pravilnikom o dokazu stvarnosti 4.2.1, a radnja 15 putanju doprinosa razmeni uvedenu članom 40b Pravilnika o KOLO sistemu. **Radnja 11 (Modul 4 — Deca) aktivira se ovom procenom**, uz Pravilnik o učešću dece.
...
Detaljne kategorije podataka, kategorije lica, primaoci, rokovi čuvanja i mere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v4.5.2) koji se primenjuje zajedno sa ovom procenom.
...
| R11 — Otkrivanje pripadnosti posebnoj kategoriji verifikatorima i u javnoj evidenciji | 3 | 3 | 9 | U postupku potvrde socijalnog programa verifikatori podnosioca saznaju da se prijavio za određeni program, što može ukazati na posebnu kategoriju (npr. invaliditet, status roditelja). Isti podatak nosi i sam zapis o evidentiranom POEN-u: uz pseudonim korisnika prikazuje se osnov evidentiranja, uključujući naziv programa, i vidljiv je svakom verifikovanom korisniku, trajno. Zato je verovatnoća ocenjena kao 3, a ne 2 — krug primalaca nije ograničen na verifikatore. Mere: postupak se pokreće isključivo uz izričit pristanak koji imenuje broj lica koja će biti zamoljena i javnost zapisa; verifikatorima se ne prikazuje sadržaj prijave (datumi rođenja dece, rešenje, dob); obaveštavanje isključivo u platformi — poruka koja iz nje izlazi ne sadrži ni naziv programa ni pseudonim; povlačenje pristanka moguće u svakom trenutku, radnjom dostupnom uz sam program, uz brisanje unetih podataka; uneti podaci brišu se i pri svakom drugom prestanku prijave. |
