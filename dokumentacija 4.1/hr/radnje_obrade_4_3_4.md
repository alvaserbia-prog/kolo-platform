...
*Ovaj se registar donosi na temelju čl. 47. Zakona o zaštiti podataka o ličnosti („Sl. glasnik RS“, br. 87/2018, u daljnjem tekstu: ZZPL), čl. 62. i 63. Pravilnika o KOLO sustavu (verzija 4.3.4) i čl. 9. Pravilnika o hijerarhiji akata KOLO sustava. Primjenjuje se zajedno s Politikom privatnosti KOLO platforme (verzija 4.3.4) i Pravilnikom o programima podrške (verzija 4.3.4).*
...
| **Status** | AKTIVNO — Modul 3. aktivira se u skladu s čl. 57. Pravilnika i Pravilnikom o programima podrške (v4.3.4); aktiviranje je popraćeno ažuriranjem DPIA-e (v4.3.0). |
| --- | --- |
...
| **Svrha obrade** | Utvrđivanje ispunjenosti uvjeta za evidentiranje doprinosa kroz kanal doprinosa sadržaju platforme, koji se od verzije 4.2.1 evidentira kroz putanju od pet koraka (Pravilnik o KOLO sustavu 4.3.4, čl. 15. t. 8. i čl. 40.b). Sporedna svrha: sprječavanje da se doprinos ostvari bez stvarne razmjene. |
| --- | --- |
