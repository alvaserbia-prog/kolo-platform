...
| **Povezani dokumenti** | Pravilnik o KOLO sustavu (v4.4.1), Politika privatnosti (v4.4.1), Registar radnji obrade (v4.4.1), Pravilnik o programima podrške (v4.4.1), Pravilnik o hijerarhiji akata (v4.4.1), Statut (v4.1), Whitepaper (v4.4.1) |
...
Detaljne kategorije podataka, kategorije osoba, primatelji, rokovi čuvanja i mjere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v4.4.1) koji se primjenjuje zajedno s ovom procjenom.
