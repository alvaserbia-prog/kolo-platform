...
| **Kategorije osoba** | Korisnici koji pripadaju kvalificiranim skupinama (roditelji, starije osobe, osobe s invaliditetom, učenici i studenti) i njihovi verifikatori. Kod potpore majkama i **djeca korisnika koja sama nisu korisnici Platforme** — o njima se obrađuje isključivo datum rođenja, bez imena; pravna je osnova privola roditelja odnosno zakonskog zastupnika (čl. 16. ZZPO-a), koju daje sam podnositelj prijave. |
...
| **Mjere zaštite** | Podaci se vode pseudonimizirano i dostupni su samo osobi koja u Zakladi obrađuje prijavu; verifikatori i drugi korisnici nemaju uvid u unesene podatke. Minimizacija: evidentiraju se samo datumi (datumi rođenja djece bez imena, datum rješenja o invalidnosti bez broja/dijagnoze). Prijava zahtijeva indeks stvarnosti od najmanje 10 % i izričitu privolu. Tvrda blokada: prijava se ne odobrava dok svi verifikatori ne potvrde; odbijanje zahtijeva obrazloženje. Obavještavanje verifikatora isključivo unutar platforme: obavijest se prikazuje u računu, a poruka koju platforma šalje elektroničkom poštom ili na uređaj ne sadrži ni naziv programa ni pseudonim podnositelja. Minimizacija: verifikatoru se ne prikazuje sadržaj prijave. Povlačenje privole provedeno kao radnja dostupna korisniku uz sam program, uz brisanje unesenih podataka. Po okončanju postupka zahtjevi za potvrdu i obavijesti o njima uklanjaju se iz računa verifikatora. Pojedinačno evidentiranje po programu izostavljeno je iz javnog pregleda evidencije i opis zapisa ne imenuje program; objavljuje se dnevni zbroj po programu, a dan s jednim korisnikom se ne objavljuje, jer bi zbroj bio jednak pojedinačnom iznosu. Izostavlja se i sam iznos, budući da se izvodi iz podataka na temelju kojih je pravo utvrđeno (godina rođenja korisnika odnosno broj i dob djece) i sam bi ih odao. |
