...
| **Povezani dokumenti** | Pravilnik o KOLO sustavu (v4.2.0), Politika privatnosti (v4.1.1), Registar radnji obrade (v4.2.0), Pravilnik o programima podrške (v4.1.1), Pravilnik o hijerarhiji akata (v4.1.1), Statut (v4.1), Whitepaper (v4.1.1) |
...
Sustav u Fazi 1. obuhvaća četrnaest radnji obrade utvrđenih Registrom radnji obrade (v4.2.0). Radnje 1.–10. i 12.–14. su aktivne (Modul 3. — Socijalni programi aktiviran je ovom procjenom, radnja 13. obuhvaća javni popis donacija, a radnja 14. nadzorni predmet uveden Pravilnikom o dokazu stvarnosti 4.2.0); radnja 11. neaktivna je do aktiviranja Modula 4.
