...
Infrastrukturu Protokola održavaju sljedeći izvršitelji obrade u smislu čl. 45. ZZPL-a, svi na temelju ugovora o obradi: Vercel Inc. (hosting i isporuka aplikacije), Neon Inc. (baza podataka), Cloudflare, Inc. (skladište slika — usluga Cloudflare R2; u bazu se upisuje samo URL slike), Resend, Inc. (dostava sustavnih poruka e-poštom) i Telegram Messenger Inc. (kanal upozorenja Zakladi). Uz njih, po privoli korisnika, Google Ireland Limited odnosno Google LLC obrađuje podatke o posjećenosti. Bankovna dokumentacija donacija ostaje kod Zaklade i, po potrebi, kod revizora; kartično plaćanje donacije obrađuju poslovna banka Zaklade i njezin posrednik za plaćanje na internetu, oboje u Republici Srbiji.

Vercel Inc. i Neon Inc. društva su iz SAD-a, ali se **aplikacija izvršava, a baza podataka nalazi u Europskoj uniji, u regiji Frankfurt**. Europska unija osigurava primjerenu razinu zaštite, pa za te podatke nema prekograničnog prijenosa u smislu čl. 65.–69. ZZPL-a; ostaje mogućnost pristupa iz SAD-a u administrativne i tehničke svrhe. Prekogranični prijenos stvarno se obavlja za slike (Cloudflare R2), elektroničku poštu koju Platforma šalje (Resend), upozorenja Zakladi (Telegram) i mjerenje posjećenosti (Google), i uređuje se u skladu s čl. 65.–69. ZZPL-a i čl. 9. Politike privatnosti.
...
Emisija POEN-a, izračun obračunskog koeficijenta i poništenje potvrde stvarnosti zbog neaktivnosti u postupku iz čl. 6. Pravilnika o sudjelovanju djece automatizirane su obrade koje mogu pravno ili znatno utjecati na osobu u smislu čl. 38. ZZPL-a. Poništenje je jedino od njih koje dira status osobe: nastupa istekom roka, bez odluke tijela Zaklade, a posljedica mu je gubitak dane potvrde i otpis POEN-a evidentiranog povodom nje, i kada zapis time prijeđe u negativnu vrijednost. Zato uz njega stoje posebna jamstva: obavijest svakoj osobi koja bi poništenjem bila pogođena prije isteka roka, izričito pravo prigovora o kojem odlučuje čovjek, i zapis koji poništenje ne označava kao utvrđenu neistinitu potvrdu. Zaklada osigurava: deterministički definiranu javnu formulu za obračunski koeficijent, pravo korisnika na objašnjenje logike, pravo na ljudski uvid i pravo na prigovor. Javnost formule i deterministički pristup smanjuju rizik proizvoljnosti. Zaključak: obrada je nužna za funkcioniranje sustava, uz odgovarajuća jamstva.
...
| R2 — Reidentifikacija pseudonimiziranih podataka | 2 | 3 | 6 | Kombiniranje pseudonimne evidencije s vanjskim izvorima može dovesti do identifikacije. Uz to, prestankom statusa račun se pseudonimizira, a ne anonimizira: Zaklada zadržava interni identifikator, pa zadržani zapisi ostaju osobni podaci i reidentifikacija je na njezinoj strani moguća. Mjere: ne postoji središnja tablica koja pseudonim povezuje s imenom, razdvajanje identifikacijskih i obračunskih podataka, ograničen pristup, mjere iz točke 5.14. |
...
| R11 — Otkrivanje pripadnosti posebnoj kategoriji drugim korisnicima | 3 | 3 | 9 | Verifikatori podnositelja u postupku potvrde saznaju da se prijavio za određeni program, a od ove procjene naziv programa i iznos vide **svi verificirani korisnici**. Vjerojatnost se vraća s 2 na 3, i to iz istoga razloga iz kojega je bila spuštena: spuštanje je počivalo na tome što je pojedinačno evidentiranje izašlo iz prikaza, pa je krug primatelja bio ograničen na osobe koje podnositelja i inače osobno poznaju. Ta je mjera odlukom vlasnika ukinuta u korist provjerljivosti evidencije prema zajednici, pa krug primatelja više nije ograničen. Ublažava je to što se **osnova unutar programa ne prikazuje nikome**: program Posebna Potpora obuhvaća i smanjenu sposobnost i gubitak doma, pa objavljen naziv ne kazuje koja je osnova u pitanju. Kod potpore starijima i majkama iznos i dalje odaje godinu rođenja, odnosno broj i dob djece, uz izričitu privolu podnositelja. Težina ostaje 3 — riječ je o posebnoj kategoriji; rizik ostaje na srednjoj razini, ali na njezinoj gornjoj granici. Mjere: vidi odjeljak 5.6. |
...
| R13 — Deanonimizacija donatora kroz javni popis donacija | 2 | 3 | 6 | Javno objavljivanje imena i prezimena donatora koji izabere javnu donaciju (uz evidentiranje POEN-a) omogućuje povezivanje pseudonimnog zapisa donatora s njegovim identitetom, čime se može deanonimizirati cjelokupna evidencija tog korisnika, budući da je donacija vezana za račun/pseudonim. Svrha: transparentnost i javno priznanje doprinosa. Pravni temelj: privola (čl. 12. ZZPL-a). Kategorije podataka: ime i prezime, iznos i datum donacije, povezani pseudonim. Primatelji: verificirani korisnici platforme. Mjere: izbor je dobrovoljan i po pojedinačnoj donaciji; jasno upozorenje prije javne donacije; anonimna opcija bez POEN-a kao alternativa; pravilo se primjenjuje samo ubuduće; ime se objavljuje isključivo u popisu donacija, dostupnom verificiranim korisnicima, i ne unosi se u opis zapisa o evidentiranom POEN-u, koji je vidljiv širem krugu — do ove procjene taj je opis nosio ime i prezime uplatitelja i stizao svakom prijavljenom računu, uključujući one kojima je pseudonim stranke inače maskiran; anonimna donacija ulazi u popis isključivo iznosom i datumom, bez imena, pseudonima i poveznice na profil. Ime ostaje uz zapis donacije i nakon prestanka statusa korisnika (čl. 5a. Pravilnika o pokroviteljstvu i donacijama), pa za tog korisnika povezivanje pseudonimne evidencije s identitetom ostaje moguće i nakon gašenja računa; na tu se posljedicu izričito upozorava prije svake javne donacije. |
...
| R16 — Obrada podataka djeteta prije pribavljene privole i graf prijateljstava | 2 | 4 | 8 | Maloljetna osoba može otvoriti račun sama, pa se do preuzimanja računa pseudonim, podaci za pristup računu, adresa roditelja i zapisi o prijateljstvima sklopljenim u tom razdoblju obrađuju prije privole, na temelju legitimnog interesa; graf prijateljstava uz to pokazuje krug poznanstava djeteta, a POEN evidentiran po tom grafu javno je mjerljiv u agregatu. Mjere: u razdoblju prije privole opseg je sveden na ono što je nužno za uspostavljanje kontakta s roditeljem; Pričaonica, oglasi, komunikacija s punoljetnim osobama i evidentiranje POEN-a su u tom razdoblju zatvoreni, pa maloljetni korisnik nije izložen punoljetnim osobama; prijateljstva sklopljena u tom razdoblju nisu javna i po njima se doprinos ne evidentira; maloljetni korisnik može sam obrisati račun u svakom trenutku; brisanje po isteku četrnaest dana bez zahtjeva osobe, zajedno sa zapisima o prijateljstvima; u poruci roditelju samo pseudonim; dvije radnje za prekid obrade bez prijave; pun pristup tek kada roditelja potvrdi treća osoba u lancu potvrda; graf prijateljstava nije javan i roditelj ga vidi bez sadržaja razgovora; pravo na prigovor po čl. 37. ZZPL-a. Vidi točku 5.11. Navođenje škole spaja pseudonim s mjestom koje maloljetni korisnik pohađa; zato se pripadnost školi objavljuje samo zbirno, a pojedinačni pregled dostupan je prijavljenim korisnicima i s njega se ne pristupa profilu. Vlastita elektronička adresa maloljetnog korisnika je dobrovoljna i služi isključivo ponovnom pristupu računu; upisuje se tek po potvrdi sa same adrese, pa pogrešno navedena adresa ne otvara put prema računu, a obavijesti se na nju ne šalju. |
...
Deterministički definirana javna formula za obračunski koeficijent — svaki korisnik može provjeriti logiku obračuna. Pravo korisnika na objašnjenje logike obrade. Pravo na ljudski uvid — korisnik može zahtijevati da odluku preispita ovlaštena osoba. Pravo na prigovor u skladu s čl. 38. ZZPL-a. Za poništenje potvrde stvarnosti zbog neaktivnosti prigovor je posebno predviđen kao vrsta prigovora na odluku, a prije isteka roka obavještava se svaka osoba koja bi poništenjem bila pogođena.
...
Izričita privola — prijava na program i traženje potvrde od verifikatora pokreću se isključivo uz izričitu privolu podnositelja. Privola se traži prije nego što se od bilo koga zatraži potvrda i izričito imenuje: koliko će osoba biti zamoljeno; da te osobe saznaju o kojem je programu riječ i da im to može otkriti pripadnost posebnoj kategoriji; i da se pojedinačno evidentiranje POEN-a po programu ne objavljuje, nego se objavljuje dnevni zbroj po programu, bez imena i pseudonima korisnika. Minimizacija prema verifikatorima — verifikatorima se ne prikazuje sadržaj prijave (datumi rođenja djece, rješenje o invalidnosti, životna dob); oni potvrđuju isključivo na temelju osobnog poznanstva s podnositeljem. Ograničen krug primatelja u postupku — zahtjev za potvrdu prima samo vlastita mreža verifikatora podnositelja (osobe koje ga već osobno poznaju), a ne i šira zajednica. Posebne kategorije samo kod obrađivača prijave — uneseni su podaci dostupni isključivo osobi koja obrađuje prijavu u Zakladi, koja je jedina i ovlaštena o prijavi odlučiti. Bez vanjskih kanala — obavijest o zahtjevu za potvrdu prikazuje se isključivo unutar platforme; poruka koju platforma šalje elektroničkom poštom ili na uređaj korisnika ne sadrži ni naziv programa ni pseudonim podnositelja. Tvrda blokada i odgovornost — prijava se ne odobrava dok svi verifikatori ne potvrde pod punom odgovornošću; odbijanje zahtijeva obrazloženje. Povlačenje privole — provedeno kao radnja dostupna korisniku uz sam program, u svakom trenutku i bez navođenja razloga; povlačenjem se postupak prekida, evidentiranje prestaje, a uneseni se podaci brišu. Brisanje unesenih podataka pri prestanku prijave — podaci uneseni u prijavu brišu se i kada je prijava odbijena, obustavljena pri reviziji statusa ili kada prestane svojstvo korisnika; ponovna prijava traži ponovni unos i ponovnu potvrdu svih verifikatora. Zatvaranje postupka — po okončanju postupka zahtjevi za potvrdu i obavijesti o njima uklanjaju se iz računa verifikatora. Dokaz statusa invaliditeta je rješenje nadležnog tijela — ne prikupljaju se medicinska dokumentacija ni dijagnoza (minimizacija posebnih kategorija).

Gradiran prikaz pojedinačnog zapisa i izostavljanje osnove — pojedinačno evidentiranje doprinosa po socijalnom programu prikazuje se verificiranim korisnicima, uz pseudonim, naziv programa i iznos. Neprijavljenim osobama i korisnicima čija stvarnost nije potvrđena prikazuje se dnevni zbroj po programu (broj korisnika i ukupan iznos), a dan u kojem je u jednom programu doprinos evidentiran samo jednom korisniku ne objavljuje se, jer bi zbroj tada bio jednak pojedinačnom iznosu. Nosiva mjera nije više izostavljanje zapisa nego **izostavljanje osnove**: osnova po kojoj je pravo u okviru programa ostvareno ne prikazuje se nijednom korisniku, pa objavljen naziv programa Posebna Potpora — koji obuhvaća i smanjenu sposobnost i gubitak doma — ne kazuje koja je osnova u pitanju. Kod potpore starijima i potpore majkama iznos se izvodi iz podataka na temelju kojih je pravo utvrđeno (godina rođenja korisnika, odnosno broj i dob djece) i odaje ih; iznos se ipak prikazuje, jer je provjerljivost evidencije prema zajednici odabrana kao pretežniji interes, a podnositelj pri prijavi izričito pristaje i na to što se iz iznosa može izvesti. Opis zapisa i dalje ne imenuje program — naziv se izvodi iz prijave, a ne iz opisa, koji je trajan i ulazi u izvoz podataka. Raščlamba po osnovi dostupna je samom korisniku, uz program, i osobi koja u Zakladi obrađuje prijavu.

Privola roditelja za podatak o djetetu — kod potpore majkama obrađuje se datum rođenja djeteta koje samo nije korisnik Platforme. Pravna je osnova privola roditelja odnosno zakonskog zastupnika (čl. 16. ZZPO-a), koju daje sam podnositelj prijave; obrađuje se isključivo datum rođenja, bez imena djeteta i bez drugog podatka o njemu, a briše se kada prijava prestane vrijediti.

Prihvaćena posljedica — pripadnost programu ostaje poznata vlastitim verifikatorima podnositelja i nakon prestanka prijave. To se ne može ukloniti a da se ne ukine sam mehanizam potvrde, koji štiti integritet programa od neistinitih prijava. Umanjenje je u tome što se privola daje nakon što je ta posljedica izričito priopćena, zajedno s jedinom alternativom — da se korisnik na program ne prijavi.
...
**Minimizacija u razdoblju prije privole** — do preuzimanja računa od roditelja obrađuju se pseudonim, podaci nužni za pristup računu, elektronička adresa roditelja i zapisi o prijateljstvima sklopljenim u tom razdoblju; datum rođenja ne traži se od djeteta nego ga upisuje roditelj, i nakon upisa se ne mijenja. **Zatvorene funkcije u tom razdoblju** — Pričaonica, oglasi, komunikacija s punoljetnim osobama i evidentiranje POEN-a nisu dostupni dok račun nije preuzet, pa maloljetni korisnik u tom razdoblju nije izložen punoljetnim osobama; prijateljstvo sklapa isključivo skeniranjem koda uživo, s drugim maloljetnim korisnikom. **Vlastiti izlaz maloljetnog korisnika** — maloljetni korisnik čiji račun čeka preuzimanje može ga sam obrisati u svakom trenutku, bez posredovanja roditelja i bez obraćanja Zakladi. **Rok kao mjera** — račun koji nitko ne preuzme u roku od četrnaest dana briše se bez zahtjeva osobe. **Bez identificirajućih podataka u poruci trećoj osobi** — u pozivu roditelju stoji samo pseudonim, nikad ime, jer točnost adrese nije provjerena. **Dva izlaza bez prijave** — primatelj poruke može izjaviti da nije roditelj tog djeteta i može obrisati račun. **Posredna, ali stvarna provjera identiteta roditelja** — pun pristup i evidentiranje doprinosa otvaraju se tek kada roditelj postane verificirani korisnik kroz lanac potvrda. **Sužen uvid roditelja** — razgovori između maloljetnih korisnika ne prikazuju se roditelju; prikazuju se prijateljstva s datumima i razgovori bez sadržaja. **Obavještavanje punoljetnog sugovornika** — u razgovoru s maloljetnim korisnikom punoljetnom se korisniku prikazuje da razgovor čita roditelj. **Filtriranje dječje Pričaonice grafom prijateljstava** — maloljetni korisnik vidi poruke svojih prijatelja, a odgovor s navođenjem tuđe poruke nije podržan da se filtar ne bi zaobišao. **Nejavnost grafa** — prijateljstva nisu javna i ne ulaze u javne agregate. **Bez automatiziranog odlučivanja** — evidentiranje doprinosa primjena je javno objavljenih pravila i ne dira status korisnika (čl. 38. ZZPL-a). **Zatvoren profil maloljetnog korisnika** — punoljetnim korisnicima se umjesto profila prikazuje obavijest s pseudonimom roditelja; suglasnost roditelja profil ne otvara, nego uređuje komunikaciju i razmjenu. **Zbirnost pregleda po školama** — javno se objavljuju samo brojevi i udjeli, bez osobnih podataka; pojedinačni pregled maloljetnih korisnika jedne škole dostupan je isključivo maloljetnom korisniku te iste škole čiji je račun aktivan — punoljetnom korisniku, neprijavljenoj osobi i računu koji čeka preuzimanje ne prikazuje se, čime se uklanja put kojim je punoljetna osoba mogla se predstaviti kao maloljetni korisnik i pribaviti pregled s pseudonimima i iznosima — i s njega se ne pristupa profilu. Transakcija u kojoj je bilo koja stranka maloljetni korisnik ne prikazuje se u pregledu evidencije nijednom promatraču. **Bez povijesti odabira škole** — čuva se samo tekuća vrijednost i trenutak posljednje izmjene, uz rok od trideset dana između dviju promjena. **Potvrda vlastite elektroničke adrese** — adresa koju navede maloljetni korisnik upisuje se tek nakon što je potvrdi otvaranjem poveznice poslane na tu adresu; pogreška u tipkanju time ne predaje pristup računu trećoj osobi. **Svrha uža od kanala** — na adresu maloljetnog korisnika ne šalju se obavijesti; ona služi samo postavljanju nove lozinke. **Izlaz i bez adrese** — kada maloljetni korisnik nema vlastitu adresu, novu lozinku postavlja roditelj, uz obavijest maloljetnom korisniku, pa zaboravljena lozinka ne znači gubitak računa. **Procjena razmjernosti za obradu na temelju legitimnog interesa** — obrada elektroničke adrese roditelja i podataka maloljetnog korisnika u razdoblju do preuzimanja računa temelji se na legitimnom interesu (čl. 12. st. 1. t. 6. ZZPL-a). Interes je pribavljanje privole koju zakon zahtijeva: bez kontakta s roditeljem privola se ne može ni zatražiti, pa se bez ove obrade maloljetnoj osobi ne može omogućiti zakonit pristup. Obrada je nužna jer blažeg sredstva nema — adresa roditelja jedini je podatak kojim maloljetna osoba raspolaže, a bez zapisa o samom računu poziv se ne bi mogao vezati ni za koga. Interesi i prava maloljetne osobe pretegnuli su gdje su mogli: opseg je sveden na nužno, razdoblje je ograničeno na četrnaest dana, funkcije koje bi maloljetnog korisnika izložile punoljetnim osobama su zatvorene, poruka roditelju sadrži samo pseudonim, primatelj poruke ima dva izlaza bez prijave, a maloljetni korisnik vlastiti izlaz. Očekivanja osobe na koju se podaci odnose poštovana su time što obradu pokreće samo maloljetna osoba, unosom adrese svog roditelja, i time što je jedini ishod obrade poruka tom roditelju. **Prihvaćena posljedica brisanja bez prijave** — račun se po pozivu može obrisati bez prijave na sustav, na temelju jednokratne ovlasti iz poruke, pa onaj tko poruku drži može obrisati račun i kada nije roditelj tog djeteta. Posljedica je prihvaćena: alternativa je da račun i dalje koristi adresu osobe koja s maloljetnim korisnikom nema veze, a jedina osoba koju sustav u tom trenutku može pitati jest ona koja poruku drži.


**Potvrda postojanja djeteta traži izjašnjavanje obiju strana** — račun otvoren po članku 4., odnosno preuzet po članku 4.b, prati izjava roditelja pod punom odgovornošću, čiji se tekst snima i nakon davanja ne mijenja; osobe koje su potvrdile stvarnost roditelja izjašnjavaju se u roku od šezdeset dana, a potvrda opstaje samo ako se izjasne oba člana veze. **Obavijest svakoj pogođenoj osobi prije isteka roka** — poništenje umanjuje zapis i osobi koja je potvrdu dala, i roditelju, i nadzorniku, pa se svima njima javlja prije isteka roka, uz iznos koji bi im bio otpisan. **Poništenje nije kvalifikacija** — u zapisu pogođene osobe stoji da je potvrda pala zbog neaktivnosti u postupku, a ne da je utvrđena neistinita potvrda; teret se ne prenosi na drugu osobu, a protiv poništenja stoji prigovor o kojem odlučuje čovjek.

## 5.12. Mjere za kolektivnu nabavu

**Minimizacija prijedloga** — prijedlog za nabavu sadrži samo naziv dobra; količina, cijena, obrazloženje i bilo koji drugi podatak ne traže se. **Zbirna objava** — registar prijedloga objavljuje se bez pseudonima; pojedinačni prijedlog se ne objavljuje. **Bez dokazivanja statusa** — kriteriji sudjelovanja se ne postavljaju, pa se ne prikupljaju isprave ni izjave o djelatnosti, imovini ili prilikama korisnika. **Bez novog prikupljanja** — broj POEN-a po kojem se utvrđuje redoslijed očitava se iz radnje br. 4. **Dobavljač ne dobiva podatke o ličnosti** — dostavlja mu se isključivo popis kodova za preuzimanje. **Suženo objavljivanje ishoda** — uz popis onih koji su preuzeli dio objavljuju se pseudonim i mjesto u redoslijedu, ali ne i broj POEN-a u zapisu. **Bez automatiziranog odlučivanja** — utvrđivanje redoslijeda primjena je javno objavljenih pravila i ne proizvodi posljedice po status korisnika (čl. 38. ZZPL-a), uz izričito pravo na prigovor o kojem odlučuje čovjek. **Brisanje** — prijedlog se briše izborom drugog naziva, uklanjanjem, provedbom nabave tog naziva i najkasnije po isteku dvanaest mjeseci.

## 5.13. Mjere za prekogranični prijenos

**Obrada u Europskoj uniji** — aplikacija se izvršava, a baza podataka nalazi se u regiji Frankfurt. Time evidencija Protokola, podaci iz prijava na programe podrške, poruke između korisnika i podaci maloljetnih korisnika ostaju u krugu s primjerenom razinom zaštite. **Uzak opseg onoga što izlazi** — u treću zemlju odlaze samo slike koje korisnici postavljaju, elektronička pošta koju Platforma šalje, upozorenja koja se šalju Zakladi i podaci o posjećenosti. **Kanal upozorenja sveden je na najmanju mjeru** — upozorenje Zakladi sadrži pseudonim i vrstu događaja, a ne sadrži podatke unesene u prijavi na program podrške ni sadržaj poruka korisnika. **Ugovor kao uvjet prijenosa** — podaci se prenose isključivo izvršitelju obrade s kojim je sklopljen ugovor o obradi koji sadrži standardne ugovorne klauzule ili druge mjere zaštite iz čl. 65. ZZPL-a. **Godišnja provjera** — Zaklada čuva primjerak svakog takvog ugovora i najmanje jednom godišnje provjerava je li na snazi i je li se popis podizvršitelja promijenio. **Mjerenje posjećenosti po privoli** — Google Analytics se ne učitava dok korisnik ne dâ privolu, a mjerenje bez kolačića ne postavlja kolačiće i ne prati korisnika između stranica.

## 5.14. Mjere za prestanak statusa i pravo na brisanje

Točno imenovan postupak — prestankom statusa račun se pseudonimizira, ne anonimizira; zadržani zapisi ostaju osobni podaci, a ograničenje brisanja počiva na čl. 30. st. 3. ZZPL-a (zakonska obveza čuvanja i pravni zahtjev), a ne na tvrdnji da su podaci prestali to biti. Brisanje sadržaja — brišu se elektronička adresa, dobrovoljno uneseni podaci, sadržaj i fotografije oglasa (oglasi se uklanjaju s prostora za oglašavanje, fotografije iz pohrane) i slobodan tekst unesen uz prijenose POEN-a. Brisanje poruka — poruke u razgovoru brišu se kada barem jedna strana ugasi račun. Izričit popis onoga što ostaje — numerički zapisi uz pseudonim koji ne upućuje na ime, osnova po kojoj je POEN upisan i ime uz javnu donaciju; opseg je nabrojan u čl. 11. Politike umjesto da se podrazumijeva. Upozorenje prije nastanka podatka — prije svake javne donacije korisnik se obavješćuje da ime ostaje na popisu i nakon gašenja računa te da mu je alternativa anonimna donacija. Pravo na ispravak — zahtjev za ispravak netočnog podatka podnosi se u Platformi, prigovorom vrste za ispravak podatka. Provjera rokova — Zaklada najmanje jednom godišnje provjerava je li za neku kategoriju podataka rok čuvanja istekao.
...
Nakon primjene svih navedenih mjera, rezidualni se rizik ocjenjuje prihvatljivim. Najviši su rezidualni rizici R1 (neovlašten pristup), R2 (reidentifikacija), R11 (otkrivanje pripadnosti posebnoj kategoriji drugim korisnicima), R13 (deanonimizacija donatora kroz javni popis donacija) i R16 (dječji prostor), svi na srednjoj razini (5–9); R11 je ovom procjenom porastao sa 6 na 9, dakle na gornju granicu te razine, jer pojedinačno evidentiranje po programu više nije izostavljeno iz prikaza. Rizik R8 (prekogranični prijenos) pada na nisku razinu (3) time što se aplikacija i baza podataka izvršavaju u Europskoj uniji, pa najveći dio podataka uopće ne izlazi iz kruga s primjerenom razinom zaštite. Rizik R5 (javna vidljivost oglasa) ukidanjem ploče i sužavanjem obrade pada na nisku razinu (4). Ti se rizici dodatno umanjuju kontinuiranim nadzorom, redovitim testiranjem i ažuriranjem mjera.
...
Modul 3. aktivira se ovom procjenom, u skladu s čl. 57. Pravilnika i Pravilnikom o programima podrške (v4.6.1). Sustav uvodi obradu posebnih kategorija podataka — status roditelja, životna dob, invaliditet (rješenje nadležnog tijela — ne dijagnoza), studentski status (čl. 17. ZZPL-a). Pravni je temelj izričita privola korisnika (čl. 17. st. 2. t. 1. ZZPL-a). Zaklada ne čuva preslike podnesene dokumentacije — ostaje samo minimalni zapis o pripadnosti skupini i datum verifikacije.

Radi zaštite integriteta programa od neistinitih prijava, prije odobravanja ispunjenost uvjeta potvrđuju svi verifikatori podnositelja, pod punom odgovornošću i na temelju osobnog poznanstva, bez uvida u unesene podatke; odbijanje zahtijeva obrazloženje, a prijava se ne odobrava dok svi ne potvrde (tvrda blokada). Taj postupak uvodi rizik R11 (otkrivanje pripadnosti posebnoj kategoriji vlastitim verifikatorima i, kroz javnu evidenciju, svim verificiranim korisnicima), za koji su mjere utvrđene u točki 5.6.
...
**Dva ulaza i prozor prije privole.** Račun maloljetnog korisnika otvara roditelj iz svog računa ili ga maloljetna osoba otvara sama. U drugom slučaju postoji prozor u kojem se podaci obrađuju PRIJE pribavljene privole roditelja. Razdoblje je namjerno svedeno na najmanju mjeru: obrađuju se pseudonim, podaci nužni za pristup računu, elektronička adresa roditelja i zapisi o prijateljstvima sklopljenim u tom razdoblju; Pričaonica, oglasi i komunikacija s punoljetnim osobama su zatvoreni, doprinos se ne evidentira, maloljetni korisnik račun može sam obrisati, a račun koji nitko ne preuzme u roku od četrnaest dana briše se. Obrada se u tom razdoblju temelji na legitimnom interesu (čl. 12. st. 1. t. 6. ZZPL-a), uz procjenu razmjernosti u točki 5.11. Rok od četrnaest dana mjera je zaštite, a ne operativna pogodnost.
