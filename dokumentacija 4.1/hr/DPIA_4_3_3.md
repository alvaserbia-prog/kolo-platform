...
| **Povezani dokumenti** | Pravilnik o KOLO sustavu (v4.3.3), Politika privatnosti (v4.3.3), Registar radnji obrade (v4.3.3), Pravilnik o programima podrške (v4.3.3), Pravilnik o hijerarhiji akata (v4.3.3), Statut (v4.1), Whitepaper (v4.3.3) |
...
Detaljne kategorije podataka, kategorije osoba, primatelji, rokovi čuvanja i mjere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v4.3.3) koji se primjenjuje zajedno s ovom procjenom.
