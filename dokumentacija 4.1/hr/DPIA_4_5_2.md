...
| **Povezani dokumenti** | Pravilnik o KOLO sustavu (v4.5.2), Politika privatnosti (v4.5.2), Registar radnji obrade (v4.5.2), Pravilnik o programima podrške (v4.5.0), Pravilnik o hijerarhiji akata (v4.4.6), Statut (v4.1), Whitepaper (v4.4.6) |
...
Detaljne kategorije podataka, kategorije osoba, primatelji, rokovi čuvanja i mjere zaštite za svaku radnju obrade utvrđeni su Registrom radnji obrade (v4.5.2) koji se primjenjuje zajedno s ovom procjenom.
...
| R11 — Otkrivanje pripadnosti posebnoj kategoriji verifikatorima i u javnoj evidenciji | 3 | 3 | 9 | U postupku potvrde socijalnog programa verifikatori podnositelja saznaju da se prijavio za određeni program, što može ukazati na posebnu kategoriju (npr. invaliditet, status roditelja). Isti podatak nosi i sam zapis o evidentiranom POEN-u: uz pseudonim korisnika prikazuje se osnova evidentiranja, uključujući naziv programa, i vidljiv je svakom verificiranom korisniku, trajno. Zato je vjerojatnost ocijenjena kao 3, a ne 2 — krug primatelja nije ograničen na verifikatore. Mjere: postupak se pokreće isključivo uz izričitu privolu koja imenuje broj osoba koje će biti zamoljene i javnost zapisa; verifikatorima se ne prikazuje sadržaj prijave (datumi rođenja djece, rješenje, dob); obavještavanje isključivo u platformi — poruka koja iz nje izlazi ne sadrži ni naziv programa ni pseudonim; povlačenje privole moguće je u svakom trenutku, radnjom dostupnom uz sam program, uz brisanje unesenih podataka; uneseni podaci brišu se i pri svakom drugom prestanku prijave. |
...
Modul 3. aktivira se ovom procjenom, u skladu s čl. 57. Pravilnika i Pravilnikom o programima podrške (v4.5.0). Sustav uvodi obradu posebnih kategorija podataka — status roditelja, životna dob, invaliditet (rješenje nadležnog tijela — ne dijagnoza), studentski status (čl. 17. ZZPL-a). Pravni je temelj izričita privola korisnika (čl. 17. st. 2. t. 1. ZZPL-a). Zaklada ne čuva preslike podnesene dokumentacije — ostaje samo minimalni zapis o pripadnosti skupini i datum verifikacije.
