...
| **Status** | AKTIVNO — Modul 3 se aktivira u skladu sa čl. 57 Pravilnika i Pravilnikom o programima podrške (v4.3.3); aktiviranje je praćeno ažuriranjem DPIA (v4.3.0). |
| --- | --- |
