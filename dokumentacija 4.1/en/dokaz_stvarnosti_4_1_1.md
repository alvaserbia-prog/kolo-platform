...
Upon recording of the verification record, the Protocol automatically enters new POEN records: 1,000 POEN to the verifier and 1,000 POEN to the verified user.

If the verification is subject to supervision, the Protocol enters 500 POEN to the supervisor at the moment the supervisor confirms the verification (Article 11), and not at the moment of verification. Until the supervision is confirmed, no supervisor has been designated.

When a verification is not subject to supervision, the total ledger entry is 2,000 POEN. When it is subject to supervision, the total ledger entry upon completion of supervision is 2,500 POEN.
