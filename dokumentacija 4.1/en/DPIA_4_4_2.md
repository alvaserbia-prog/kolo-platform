...
| **Related documents** | Rulebook on the KOLO System (v4.4.1), Privacy Policy (v4.4.2), Records of Processing Activities (v4.4.2), Rulebook on Support Programmes (v4.4.1), Rulebook on the Hierarchy of Acts (v4.4.1), Statute (v4.1), Whitepaper (v4.4.1) |
...
Detailed categories of data, categories of data subjects, recipients, retention periods, and protection measures for each processing activity are established by the Records of Processing Activities (v4.4.2) applied together with this assessment.
