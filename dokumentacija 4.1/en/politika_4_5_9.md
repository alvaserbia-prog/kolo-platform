...
Application to a social program and requesting confirmation from verifiers is carried out exclusively with your explicit consent and with a reality index of at least 10%. Before approval, the fulfilment of conditions is confirmed by your verifiers — persons who know you personally — under full responsibility and without access to the entered data; the application is not approved until all confirm, and a refusal requires a reason. Consent is requested before confirmation is requested from anyone, and it states how many persons will be asked. Those persons learn which program is concerned, which may reveal to them your membership in a special category; they are notified exclusively within the Platform — the message sent by electronic mail or to your device states neither the name of the program nor your pseudonym.

The record of POEN recorded is not hidden. The Protocol ledger is public to the extent set out in Article 6 of this policy: every verified user is shown, alongside your pseudonym, the basis on which the POEN was recorded, including the name of the social program. Unregistered visitors see only aggregate indicators, and logged-in users without confirmation do not see the pseudonyms of the parties. This publicity is a condition of the ledger's verifiability — the total number of POEN is public and the sum of the records in the Protocol is zero, so an entry that cannot be attributed to a basis could not be checked. If you do not wish this information to be visible, the only option is not to apply for the program.
