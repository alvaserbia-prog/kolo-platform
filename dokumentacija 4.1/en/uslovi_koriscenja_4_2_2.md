...
A listing posted by an unverified user must meet the content minimum: at least one photograph, a category, and a place. A listing that does not meet the content minimum is not published. The same condition applies when an already published listing is edited.
