...
| **Subject of assessment** | KOLO system — Phase 1, active processing activities no. 1–10 and no. 12–15 (including the activated Module 3 — Social Programs with verifier confirmation, Integrity Monitoring of the Verification System, the public list of donations, the supervision case, and the exchange contribution path); inactive processing activity no. 11 (Module 4 — Children) |
| **Related documents** | Rulebook on the KOLO System (v4.2.2), Privacy Policy (v4.2.2), Records of Processing Activities (v4.2.2), Rulebook on Support Programmes (v4.2.2), Rulebook on the Hierarchy of Acts (v4.2.2), Statute (v4.1), Whitepaper (v4.2.2) |
...
The system in Phase 1 encompasses fifteen processing activities defined by the Records of Processing Activities (v4.2.2). Activities 1–10 and 12–15 are active (Module 3 — Social Programs is activated by this assessment, activity 13 covers the public list of donations, activity 14 the supervision case introduced by the Rulebook on Proof of Reality 4.2.1, and activity 15 the exchange contribution path introduced by Article 40b of the Rulebook on the KOLO System); activity 11 is inactive until the activation of Module 4.
...
Detailed categories of data, categories of data subjects, recipients, retention periods, and protection measures for each processing activity are established by the Records of Processing Activities (v4.2.2) applied together with this assessment.
...
Thirteen risks to the rights and freedoms of data subjects have been identified. No risk has been assessed as high. Six risks are at the medium level (R1, R2, R5, R8, R11, R13), and seven at the low level (R3, R4, R6, R7, R9, R10, R12).
