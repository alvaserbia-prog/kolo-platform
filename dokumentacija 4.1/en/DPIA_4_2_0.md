...
| **Related documents** | Rulebook on the KOLO System (v4.2.0), Privacy Policy (v4.1.1), Records of Processing Activities (v4.2.0), Rulebook on Support Programmes (v4.1.1), Rulebook on the Hierarchy of Acts (v4.1.1), Statute (v4.1), Whitepaper (v4.1.1) |
...
The system in Phase 1 encompasses fourteen processing activities defined by the Records of Processing Activities (v4.2.0). Activities 1–10 and 12–14 are active (Module 3 — Social Programs is activated by this assessment, activity 13 covers the public list of donations, and activity 14 the supervision case introduced by the Rulebook on Proof of Reality 4.2.0); activity 11 is inactive until the activation of Module 4.
...
Detailed categories of data, categories of data subjects, recipients, retention periods, and protection measures for each processing activity are established by the Records of Processing Activities (v4.2.0) applied together with this assessment.
