...
| **Related documents** | Rulebook on the KOLO System (v4.3.3), Privacy Policy (v4.3.3), Records of Processing Activities (v4.3.3), Rulebook on Support Programmes (v4.3.3), Rulebook on the Hierarchy of Acts (v4.3.3), Statute (v4.1), Whitepaper (v4.3.3) |
...
Detailed categories of data, categories of data subjects, recipients, retention periods, and protection measures for each processing activity are established by the Records of Processing Activities (v4.3.3) applied together with this assessment.
