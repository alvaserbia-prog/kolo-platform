...
*Ovaj registar donosi se na osnovu čl. 47 Zakona o zaštiti podataka o ličnosti („Sl. glasnik RS“, br. 87/2018, u daljem tekstu: ZZPL), čl. 62 i 63 Pravilnika o KOLO sistemu (verzija 4.6.2) i čl. 9 Pravilnika o hijerarhiji akata KOLO sistema. Primenjuje se zajedno sa Politikom privatnosti KOLO platforme (verzija 4.6.3) i Pravilnikom o programima podrške (verzija 4.6.1).*
...
| **Lice za zaštitu podataka** | Nije određeno — obaveza iz člana 56 stav 2 ZZPL-a nije ispunjena; procena se preispituje najmanje jednom godišnje (Politika privatnosti, član 1). Kontakt za zaštitu podataka: privatnost@ekolo.rs |
...
| **Pravni osnov** | Izvršenje ugovornog odnosa (čl. 12 st. 1 t. 2 ZZPL-a) — korisnik pristupanjem sistemu prihvata pravila korišćenja. Prihvatanje Uslova korišćenja i Politike privatnosti beleži se pri otvaranju naloga, odvojeno za svaki akt, uz trenutak, oznaku verzije i tekst koji je korisniku bio prikazan (čl. 4a Politike privatnosti); bez tog zapisa nalog se ne otvara. |
...
| **Rok čuvanja** | Dok korisnički nalog ostaje aktivan. Po prestanku statusa brišu se elektronska adresa, dobrovoljno uneti podaci, sadržaj i fotografije oglasa i slobodan tekst uz prepise POEN-a, a preostali podaci se pseudonimizuju u skladu sa čl. 34 Pravilnika i čl. 11 Politike privatnosti. Pseudonimizacija nije anonimizacija: Fondacija zadržava interni identifikator naloga, pa zadržani zapisi ostaju podaci o ličnosti. |
| **Mere zaštite** | Hashiranje lozinke, TLS enkripcija u prenosu (min. verzija 1.2), enkripcija u mirovanju na nivou hosting infrastrukture, kontrola pristupa po principu minimalne neophodnosti, višefaktorska autentifikacija za administrativni pristup. Zapis o prihvatanju akata vodi se bez IP adrese i podataka o uređaju; na adresu unetu pri registraciji upućuje se poruka sa linkom za potvrdu, koja nije uslov za korišćenje naloga. |
...
| **Status** | AKTIVNO — Modul 3 se aktivira u skladu sa čl. 57 Pravilnika i Pravilnikom o programima podrške (v4.6.1); aktiviranje je praćeno ažuriranjem DPIA (v4.3.0). |
| --- | --- |
...
| **Kategorije lica** | Korisnici koji pripadaju kvalifikovanim grupama (roditelji, starija lica, korisnici u otežanim okolnostima, učenici i studenti) i njihovi verifikatori. Kod programa Posebna Podrška i **lice o kome se korisnik neposredno stara, kada samo nije korisnik Platforme** — o njemu se obrađuje isključivo podatak da postoji lice kome je potrebna stalna pomoć i, kada je maloletno, njegov datum rođenja bez imena, radi utvrđivanja trenutka u kome pravo prestaje. Kod podrške majkama i **deca korisnika koja sama nisu korisnici Platforme** — o njima se obrađuje isključivo datum rođenja, bez imena; pravni osnov je saglasnost roditelja odnosno zakonskog zastupnika (čl. 16 ZZPL-a), koju daje sam podnosilac prijave. |
| **Kategorije podataka** | Status roditelja, starosna dob, smanjena sposobnost (postojanje rešenja nadležnog organa kojim je utvrđen stepen invaliditeta, uključujući rešenje komisije za procenu radne sposobnosti — bez broja, organa, stepena, ocene radne sposobnosti, medicinske dokumentacije i dijagnoze; odnosno izjava pod punom odgovornošću o akutnoj ili hroničnoj bolesti, bez dijagnoze), gubitak doma (izjava pod punom odgovornošću, bez isprave), studentski status ili pripadnost drugoj kvalifikovanoj grupi, datum verifikacije statusa. Fondacija ne čuva kopije podnesene dokumentacije — u sistemu ostaje samo minimalni zapis o pripadnosti grupi. U postupku potvrde, verifikatorima se otkriva podatak da se podnosilac (pseudonim) prijavio za određeni program — što može ukazati na pripadnost posebnoj kategoriji — ali ne i sadržaj unetih podataka. |
| **Pravni osnov** | Izričit pristanak korisnika (čl. 17 st. 2 t. 1 ZZPL-a), dat zasebno za prijavu i za traženje potvrde od verifikatora. Pristanak izričito navodi koliko će lica biti zamoljeno da potvrdi; da se evidentiranje POEN-a po programu prikazuje verifikovanim korisnicima uz pseudonim, naziv programa i iznos; šta se iz iznosa može izvesti kod podrške starijima i podrške majkama (godina rođenja, odnosno broj i uzrast dece); i da se osnov po kome je pravo u okviru programa ostvareno ne prikazuje nijednom korisniku. Pristanak se može povući u svakom trenutku, radnjom dostupnom korisniku uz sam program, sa posledicom prestanka postupka odnosno automatskog evidentiranja. |
| **Primaoci / obrađivači** | Vercel Inc. (hosting, izvršavanje u Evropskoj uniji) i Neon Inc. (baza podataka, region u Evropskoj uniji), na osnovu ugovora o obradi. Lice koje obrađuje prijavu u Fondaciji ima uvid u unete podatke. Verifikatori podnosioca primaju isključivo zahtev za potvrdu (naziv programa i pseudonim podnosioca koga lično poznaju) — bez uvida u unete podatke. Verifikovani korisnici — kroz pregled evidencije Protokola vide pojedinačni zapis o evidentiranom POEN-u po socijalnom programu, uz pseudonim korisnika, naziv programa i iznos, ali ne i osnov po kome je pravo u okviru programa ostvareno. Neprijavljena lica i korisnici čija stvarnost nije potvrđena vide isključivo dnevni zbir po programu (broj korisnika i ukupan iznos), bez pseudonima i bez pojedinačnih iznosa (čl. 6 i 4.6 Politike privatnosti). Nijedni ne vide unete podatke. |
| **Prenos u treću zemlju** | Ne za podatke u bazi — aplikacija i baza podataka izvršavaju se u Evropskoj uniji (region Frankfurt), koja obezbeđuje primereni nivo zaštite. Vercel Inc. i Neon Inc. su društva iz SAD, pa je moguć pristup iz treće zemlje u administrativne i tehničke svrhe, uz mere iz čl. 9 Politike privatnosti. |
| **Rok čuvanja** | Podaci uneti u prijavu čuvaju se dok prijava važi i brišu se kada prijava prestane — povlačenjem pristanka, odbijanjem, obustavom pri reviziji statusa ili prestankom svojstva korisnika. Zapisi o potvrdama verifikatora (potvrđeno/odbijeno, obrazloženje odbijanja) čuvaju se uz prijavu dok status traje; nedovršeni zahtevi za potvrdu i obaveštenja o njima brišu se po okončanju postupka. Zapis o evidentiranom POEN-u ostaje u evidenciji Protokola i posle prestanka prijave, jer se evidentiran POEN ne poništava (čl. 14 Pravilnika o KOLO sistemu). |
| **Mere zaštite** | Podaci se vode pseudonimizovano i dostupni su samo licu koje u Fondaciji obrađuje prijavu; verifikatori i drugi korisnici nemaju uvid u unete podatke. Minimizacija: evidentiraju se samo datumi i postojanje osnova (datumi rođenja dece bez imena, datum rešenja bez broja, organa i stepena, izjava bez dijagnoze). Prijava zahteva indeks stvarnosti od najmanje 10% i izričit pristanak. Tvrda blokada: prijava se ne odobrava dok svi verifikatori ne potvrde; odbijanje zahteva obrazloženje. Obaveštavanje verifikatora isključivo unutar platforme: obaveštenje se prikazuje u nalogu, a poruka koju platforma šalje elektronskom poštom ili na uređaj ne sadrži ni naziv programa ni pseudonim podnosioca. Minimizacija: verifikatoru se ne prikazuje sadržaj prijave. Povlačenje pristanka sprovedeno kao radnja dostupna korisniku uz sam program, uz brisanje unetih podataka. Po okončanju postupka zahtevi za potvrdu i obaveštenja o njima uklanjaju se iz naloga verifikatora. Izostavljanje osnova: osnov po kome je pravo u okviru programa ostvareno ne prikazuje se nijednom korisniku, pa naziv programa Posebna Podrška — koji obuhvata i smanjenu sposobnost i gubitak doma — ne kazuje koji je osnov u pitanju. To je nosiva mera ove radnje. Opis zapisa i dalje ne imenuje program: naziv se izvodi iz prijave, a ne iz opisa, koji je trajan i ulazi u izvoz podataka. Neprijavljenim licima i korisnicima bez potvrđene stvarnosti prikazuje se samo dnevni zbir po programu, a dan sa jednim korisnikom se ne objavljuje, jer bi zbir bio jednak pojedinačnom iznosu. |
...
| **Prenos u treću zemlju** | Ne za podatke u bazi — aplikacija i baza podataka izvršavaju se u Evropskoj uniji (region Frankfurt), koja obezbeđuje primereni nivo zaštite. Vercel Inc. i Neon Inc. su društva iz SAD, pa je moguć pristup iz treće zemlje u administrativne i tehničke svrhe, uz mere iz čl. 9 Politike privatnosti. Kanal upozorenja Fondaciji (Telegram, Resend) je u SAD i prenos po tom osnovu postoji, uz iste mere. |
...
| **Prenos u treću zemlju** | Ne za podatke u bazi — aplikacija i baza podataka izvršavaju se u Evropskoj uniji (region Frankfurt), koja obezbeđuje primereni nivo zaštite. Vercel Inc. i Neon Inc. su društva iz SAD, pa je moguć pristup iz treće zemlje u administrativne i tehničke svrhe, uz mere iz čl. 9 Politike privatnosti. |
| **Rok čuvanja** | Kao za podatke o donacijama — 10 godina, u skladu sa poreskim i računovodstvenim propisima. Ime se ne uklanja iz liste ni prestankom svojstva korisnika (čl. 5a Pravilnika o pokroviteljstvu i donacijama), pa za tog korisnika povezivanje pseudonimne evidencije sa identitetom ostaje moguće i posle gašenja naloga. |
| **Mere zaštite** | Izbor je dobrovoljan i po pojedinačnoj donaciji; jasno upozorenje pre javne donacije; anonimna opcija bez POEN-a kao alternativa; pravilo se primenjuje samo ubuduće; TLS enkripcija, kontrola pristupa. Ime se objavljuje isključivo u listi donacija, dostupnoj verifikovanim korisnicima, i ne unosi se u opis zapisa o evidentiranom POEN-u, koji je vidljiv širem krugu; u tom zapisu stoje samo iznos i osnov. Anonimna donacija ulazi u listu isključivo iznosom i datumom — bez imena, bez pseudonima i bez veze ka profilu — pa se donator iz nje ne može utvrditi. |
| **Napomena** | Javno povezivanje imena sa donacijom omogućava povezivanje pseudonimnog zapisa donatora sa njegovim identitetom; otkrivanje je dobrovoljno. POEN se za anonimnu donaciju ne evidentira zato što se upis koji se ne može pripisati nijednom licu ne može proveriti (član 5a Pravilnika o pokroviteljstvu i donacijama), a ne zato što Fondacija objavljivanje postavlja kao uslov. |

**Radnja obrade br. 14 — Nadzorni predmet (ishod nadzora verifikacije)**

| **Svrha obrade** | Evidentiranje ishoda nadzora nad verifikacijom i vođenje nadzornog predmeta, radi utvrđivanja lažne verifikacije od strane Upravnog odbora (Pravilnik o dokazu stvarnosti 4.4.1, čl. 11, 11a i 18). Do 4.2.1 nadzornik je mogao samo da potvrdi verifikaciju; sumnja nije imala gde da se zabeleži, pa nije ni proveravana. |
| --- | --- |
...
| **Svrha obrade** | Utvrđivanje ispunjenosti uslova za evidentiranje doprinosa kroz kanal doprinosa sadržaju platforme, koji se od verzije 4.2.1 evidentira kroz putanju od pet koraka (Pravilnik o KOLO sistemu 4.4.6, čl. 15 t. 8 i čl. 40b). Sporedna svrha: sprečavanje da se doprinos ostvari bez stvarne razmene. |
| --- | --- |
...
**Radnja obrade br. 16 — Predlog za nabavku i učešće u kolektivnoj nabavci**

| **Svrha obrade** | Utvrđivanje potreba zajednice koje se ne mogu zadovoljiti unutar sistema, radi odlučivanja o kolektivnoj nabavci (čl. 51a Pravilnika o KOLO sistemu), i sprovođenje odlučene nabavke — prijava, utvrđivanje reda i preuzimanje dela. |
| --- | --- |
...
| **Napomena** | Registar predloga objavljuje se zbirno zato što služi odlučivanju o tome šta se nabavlja, a ne uvidu u to ko šta traži. Kriterijumi učešća se ne postavljaju upravo da bi se izbeglo prikupljanje podataka o delatnosti i prilikama korisnika. |

**Radnja obrade br. 17 — Privatna komunikacija između korisnika**

| **Svrha obrade** | Omogućavanje razgovora jedan na jedan između korisnika, pre svega povodom oglasa na prostoru za oglašavanje. |
| --- | --- |
| **Kategorije lica** | Korisnici koji učestvuju u razgovoru. |
| **Kategorije podataka** | Pseudonimi strana u razgovoru, sadržaj poruka koji korisnici sami unose, vreme slanja i podatak o pročitanosti, oglas povodom koga je razgovor pokrenut. |
| **Pravni osnov** | Izvršenje ugovornog odnosa (čl. 12 st. 1 t. 2 ZZPL-a) — komunikacija je sadržina odnosa po kome korisnik koristi sistem. |
| **Primaoci / obrađivači** | Isključivo druga strana u razgovoru. Roditelj maloletnog korisnika čita razgovor svog deteta sa punoletnim licem (radnja br. 11). Fondacija ne čita razgovore; uvid ima samo radi uklanjanja spornog sadržaja po čl. 25 Uslova korišćenja. Isečak nove poruke od 120 znakova ulazi u obaveštenje koje se šalje elektronskom poštom (Resend, Sjedinjene Američke Države). Infrastruktura: Vercel Inc. (hosting, izvršavanje u Evropskoj uniji) i Neon Inc. (baza podataka, region u Evropskoj uniji), na osnovu ugovora o obradi. |
| **Prenos u treću zemlju** | Ne za podatke u bazi — aplikacija i baza podataka izvršavaju se u Evropskoj uniji (region Frankfurt). Isečak poruke izlazi u SAD kroz obaveštenje elektronskom poštom, uz mere iz čl. 9 Politike privatnosti. |
| **Rok čuvanja** | Poruke se brišu kada bar jedna strana ugasi nalog, odnosno kada od poslednje poruke u razgovoru prođu 24 meseca. |
| **Mere zaštite** | Razgovor je zatvoren za treća lica; sadržaj poruka ne ulazi ni u jedan javni prikaz ni u agregate. Razgovor može da pokrene samo verifikovan korisnik. Sadržaj poruke se ne prepisuje u revizijski dnevnik pri uklanjanju. Punoletnom sagovorniku maloletnog korisnika prikazuje se da razgovor čita roditelj. TLS enkripcija, enkripcija u mirovanju, kontrola pristupa. |
| **Napomena** | Ova radnja je u registar upisana registrom v4.5.1. Obrada je postojala od početka rada Platforme, ali nije bila zasebno popisana — komunikacija je bila navedena samo kao jedna od svrha radnje br. 1, bez sopstvenih kategorija podataka i bez roka čuvanja. |

**Radnja obrade br. 18 — Dokaz pristanka i dokaz zasnivanja ugovornog odnosa**

| **Svrha obrade** | Dokazivanje da je lice dalo pristanak za obrade čiji je to pravni osnov i da je prihvatanjem Uslova korišćenja zasnovan ugovorni odnos (čl. 15 st. 1 ZZPL-a — teret dokazivanja je na rukovaocu). |
| --- | --- |
| **Kategorije lica** | Korisnici platforme; roditelji odnosno zakonski zastupnici maloletnih korisnika. |
| **Kategorije podataka** | Vrsta prihvaćenog akta odnosno pristanka, oznaka verzije, tekst koji je licu bio prikazan, jezik prikaza, trenutak davanja i, ako je do njega došlo, trenutak povlačenja. Uz zapis se ne beleže IP adresa, podaci o uređaju ni drugi identifikatori. |
| **Pravni osnov** | Poštovanje pravnih obaveza rukovaoca (čl. 12 st. 1 t. 3 ZZPL-a) — obaveza dokazivanja pristanka iz čl. 15 st. 1 ZZPL-a. |
| **Primaoci / obrađivači** | Vercel Inc. (hosting, izvršavanje u Evropskoj uniji) i Neon Inc. (baza podataka, region u Evropskoj uniji), na osnovu ugovora o obradi. |
| **Prenos u treću zemlju** | Ne za podatke u bazi — aplikacija i baza podataka izvršavaju se u Evropskoj uniji (region Frankfurt), koja obezbeđuje primereni nivo zaštite. Vercel Inc. i Neon Inc. su društva iz SAD, pa je moguć pristup iz treće zemlje u administrativne i tehničke svrhe, uz mere iz čl. 9 Politike privatnosti. |
| **Rok čuvanja** | Dok traje obrada za koju je pristanak dat i nakon toga u roku u kome se može isticati ili osporavati pravni zahtev po tom osnovu. Zapis se ne briše povlačenjem pristanka, jer povlačenje ne utiče na zakonitost obrade izvršene pre povlačenja (čl. 15 st. 3 ZZPL-a), pa dokaz da je pristanak postojao mora ostati za taj period. |
| **Mere zaštite** | Zapis nastaje u istoj atomskoj radnji kojom i nalog; provera se vrši na strani rukovaoca, ne u pretraživaču; prihvatanje svakog akta beleži se odvojeno; verzija upućuje na objavljen tekst koji se ne menja; bez prikupljanja dodatnih identifikatora; lice zapis vidi u svom nalogu i u izvozu podataka. |
| **Napomena** | Za pristanak na kolačiće koji nisu neophodni zapis uz nalog vodi se isključivo za prijavljenog korisnika; za posetioca koji nije prijavljen ne uspostavlja se identifikator, a odluka se beleži u samom kolačiću, zajedno sa verzijom obaveštenja po kojoj je doneta. |
