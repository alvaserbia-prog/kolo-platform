...
**Dva ulaza.** Nalog maloletnog korisnika otvara roditelj iz sopstvenog naloga, ili ga maloletno lice otvara samo. U drugom slučaju nalog do preuzimanja od roditelja stoji bez pristupa funkcijama sistema; o maloletnom licu se do tada obrađuju samo pseudonim i elektronska adresa roditelja, a nalog koji niko ne preuzme u roku od četrnaest dana se briše.
...
**Pravni osnov:** pristanak roditelja ili zakonskog zastupnika (čl. 16 ZZPL-a), sa dodatnim ograničenjima za lica mlađa od petnaest godina; za elektronsku adresu roditelja — legitimni interes, kako je opisano iznad.
...
**Prijava poruke.** Pošto roditelj razgovore između dece ne čita, maloletni korisnik može sam prijaviti poruku Fondaciji (Uslovi korišćenja čl. 25).
