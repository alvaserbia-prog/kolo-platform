...
| **Címzettek / adatfeldolgozók** | Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), adatfeldolgozási szerződés alapján. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
...
| **Címzettek / adatfeldolgozók** | Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), adatfeldolgozási szerződés alapján. A nyilvántartás álneves formában nyilvános — a hitelesített felhasználók láthatják az összegeket, az időbélyegeket és a felek álneveit. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
...
| **Látogatottságmérés** | Google Analytics (Google Ireland Limited, illetve Google LLC, Egyesült Államok) — kizárólag a felhasználó hozzájárulása alapján (ZZPL 12. cikk (1) bekezdés 1. pont); hozzájárulás előtt süti nem kerül elhelyezésre; a sütik nélküli mérés (Vercel Inc.) jogos érdeken alapul, webhelyek közötti követés nélkül. A Google esetében harmadik országba történő továbbítás valósul meg az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
...
| **Címzettek / adatfeldolgozók** | Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), valamint Cloudflare Inc. (fényképtár, Amerikai Egyesült Államok), adatfeldolgozási szerződés alapján. A hirdetés a platform valamennyi látogatója számára nyilvánosan hozzáférhető, ideértve a be nem jelentkezett személyeket is, és a keresőmotorok indexelik. A hirdető telefonszáma kizárólag hitelesített felhasználók számára hozzáférhető. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
...
| **Állapot** | AKTÍV — a 3. modul a szabályzat 57. cikkével és a támogatási programokról szóló szabályzattal (4.5.0 v.) összhangban aktiválódik; az aktiválást a DPIA frissítése kíséri (4.3.0 v.). |
| --- | --- |
...
| **Az érintettek kategóriái** | A minősített csoportokhoz tartozó felhasználók (szülők, idősebb személyek, fogyatékossággal élő személyek, tanulók és hallgatók) és hitelesítőik. |
...
| **Jogalap** | A felhasználó kifejezett hozzájárulása (ZZPL 17. cikk 2. bek. 1. pont), külön megadva a kérelemre és külön a hitelesítőktől való megerősítés kérésére. A hozzájárulás kifejezetten megjelöli, hány személyt kérnek fel megerősítésre, és hogy a nyilvántartásba vett POEN bejegyzése — a program megnevezésével — minden hitelesített felhasználó számára látható az álnév mellett. A hozzájárulás bármikor visszavonható a felhasználó számára magánál a programnál elérhető művelettel, aminek következménye az eljárás, illetve az automatikus nyilvántartásba vétel megszűnése. |
| **Címzettek / adatfeldolgozók** | Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), adatfeldolgozási szerződés alapján. A kérelmet az Alapítványnál feldolgozó személy betekinthet a megadott adatokba. A kérelmező hitelesítői kizárólag megerősítési kérést kapnak (a program megnevezése és az általuk személyesen ismert kérelmező álneve) — a megadott adatokba való betekintés nélkül. Minden hitelesített felhasználó — a Protokoll nyilvános nyilvántartásán keresztül látja a nyilvántartásba vett POEN bejegyzését a program megnevezésével, a felhasználó álneve mellett (az adatvédelmi szabályzat 6. cikke); a megadott adatokat nem látják. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
| **Megőrzési idő** | A kérelemben megadott adatokat a kérelem hatálya alatt őrizzük, és a kérelem megszűnésekor töröljük — a hozzájárulás visszavonása, elutasítás, a jogállás felülvizsgálatakor történő felfüggesztés vagy a felhasználói jogállás megszűnése folytán. A hitelesítői megerősítésekről szóló bejegyzések (megerősítve/elutasítva, az elutasítás indokolása) a kérelem mellett maradnak, amíg a jogállás fennáll; a megválaszolatlan megerősítési kéréseket és az azokról szóló értesítéseket az eljárás befejeztével töröljük. A nyilvántartásba vett POEN bejegyzése a kérelem megszűnése után is a Protokoll nyilvántartásában marad, mert a nyilvántartásba vett POEN-t nem semmisítjük meg (a KOLO rendszerről szóló szabályzat 14. cikke). |
| **Védelmi intézkedések** | Az adatok álnevesítve kezelendők, és csak a kérelmet az Alapítványnál feldolgozó személy számára hozzáférhetők; a hitelesítők és a többi felhasználó nem tekinthet be a megadott adatokba. Adattakarékosság: csak dátumok kerülnek nyilvántartásba (a gyermekek születési dátuma név nélkül, a rokkantsági határozat dátuma szám/diagnózis nélkül). A kérelem legalább 10 %-os valóságindexet és kifejezett hozzájárulást igényel. Kemény zárolás: a kérelem nem hagyható jóvá, amíg valamennyi hitelesítő meg nem erősítette; az elutasítás indokolást igényel. A hitelesítők értesítése kizárólag a platformon belül: az értesítés a fiókban jelenik meg, a platform által elektronikus levélben vagy az eszközre küldött üzenet pedig sem a program megnevezését, sem a kérelmező álnevét nem tartalmazza. Adattakarékosság: a hitelesítő nem látja a kérelem tartalmát. A hozzájárulás visszavonása a felhasználó számára magánál a programnál elérhető műveletként valósul meg, a megadott adatok törlésével. Az eljárás befejezését követően a megerősítési kérések és az azokról szóló értesítések törlődnek a hitelesítők fiókjából. |

**11. sz. adatkezelési tevékenység — Kiskorúak adatai (4. modul — Gyermekek)**

| **Állapot** | AKTÍV — a 4. modult a DPIA v4.3.0 és a gyermekek részvételéről szóló szabályzat aktiválta. |
| --- | --- |
| **Az adatkezelés célja** | A kiskorú felhasználók rendszerbeli részvételének lehetővé tétele különleges korlátozási rend mellett, valamint hozzájárulásuk nyilvántartásba vétele (a KOLO rendszerről szóló szabályzat 15. cikk 9. pont). |
| **Az érintettek kategóriái** | A platform kiskorú felhasználói (a hetedik életévtől a tizennyolcadik életévig) és a szülők, illetve törvényes képviselők. |
| **Az adatok kategóriái** | A kiskorú felhasználó álneve; a fiókhoz való hozzáféréshez szükséges adatok (jelszó titkosított formában); a szülő elektronikus címe, amelyet a kiskorú ad meg; a kiskorú felhasználó saját e-mail címe, ha megadja; a szülő által bejegyzett születési dátum; egy vagy két szülővel való kapcsolat és a beleegyezés; a barátságok gráfja dátumokkal; üzenetek a gyermekek Beszélgetőjében és a beszélgetésekben; POEN-bejegyzések; hirdetések; a kiskorú felhasználó által megadott iskola; a szülő nyilatkozata a gyermek létezéséről (a nyilatkozat szövege és megtételének ideje), valamint a szülő valóságát megerősítő személyeknek a gyermek létezésére vonatkozó nyilatkozatai. |
| **Jogalap** | A szülő vagy törvényes képviselő hozzájárulása (ZZPL 16. cikk), a tizenöt évnél fiatalabb személyekre vonatkozó további korlátozásokkal. A szülő elektronikus címe, valamint a kiskorú felhasználónak a fiók átvételét megelőző időszakban kezelt adatai esetében jogos érdek (ZZPL 12. cikk (1) bek. 6. pont) e hozzájárulás megszerzése céljából; az érdekmérlegelés a DPIA 5.11. pontjában található. A kiskorú felhasználó saját e-mail címét ugyanezen hozzájárulás keretében kezeljük, megadása önkéntes, célja pedig a fiókhoz való ismételt hozzáférésre korlátozódik. |
| **Címzettek / adatfeldolgozók** | Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), valamint Resend (egyetlen üzenet továbbítása a szülőnek, Amerikai Egyesült Államok), adatfeldolgozási szerződés alapján. A többi kiskorú felhasználó a barátai üzeneteit látja; a szülő a barátságok és a beszélgetések listáját látja tartalom nélkül, a beszélgetés tartalmát pedig csak akkor, ha a másik fél felnőtt. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
| **Megőrzési idő** | Ameddig a fiók aktív marad. Az a fiók, amelyet a szülő a megnyitástól számított tizennégy napon belül nem vesz át, törlődik, a szülő címével és a felhívással együtt. A barátságok a nagykorúság elérésekor és a fiók törlésekor törlődnek. A kiskorú felhasználó saját e-mail címe — amíg el nem távolítja, illetve amíg a felhasználói minőség meg nem szűnik; a meg nem erősített cím huszonnégy óra elteltével hatályát veszti. A szülő nyilatkozatát és a gyermek létezésére vonatkozó nyilatkozatokat a szülő és a gyermek közötti kapcsolat mellett őrzik, ameddig e kapcsolat fennáll. |
| **Védelmi intézkedések** | Lásd a DPIA 5.11. pontját. A legfontosabbak: a hozzájárulás előtti időszakban a terjedelem a szülővel való kapcsolatfelvételhez szükséges mértékre szorítkozik, a Beszélgető, a hirdetések, a nagykorú személyekkel való kommunikáció és a POEN bejegyzése pedig zárva van; a kiskorú felhasználó az átvételre váró fiókot maga is törölheti; a szülőnek szóló üzenetben csak az álnév szerepel, soha a név; két cselekmény az adatkezelés megszakítására bejelentkezés nélkül; teljes hozzáférés csak akkor, ha a szülőt harmadik személy megerősítette a megerősítések láncában; a szülő nem olvassa a kiskorú felhasználók közötti beszélgetéseket; a felnőtt fél értesítést kap arról, hogy a beszélgetést szülő olvassa; a gyermekek Beszélgetője a barátságok gráfja szerint szűrt, idézettel adott válasz nélkül; a kiskorú felhasználó profilja nem érhető el a nagykorú felhasználók számára, helyette a szülő álnevét tartalmazó tájékoztatás jelenik meg; az iskolánkénti áttekintés összesített és nem tartalmaz személyes adatot; a korábbi iskolaválasztások előzményei nem kerülnek megőrzésre; a kiskorú felhasználó saját e-mail címe csak az arra a címre küldött hivatkozás megnyitásával történő megerősítés után kerül bejegyzésre, értesítéseket nem küldünk rá, ha pedig nincs ilyen cím, az új jelszót a szülő állítja be; a gyermek létezésének megerősítését a kapcsolat mindkét tagja megadja, a határidő lejárta előtt értesítve mindenkit, akit az érvénytelenítés érintene, és ember által elbírált kifogásolási joggal. |
...
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. Az Alapítvány riasztási csatornája (Telegram, Resend) az Egyesült Államokban van, és e jogcímen a továbbítás fennáll, ugyanazon intézkedések mellett. |
...
| **Címzettek / adatfeldolgozók** | Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), adatfeldolgozási szerződés alapján. A platform hitelesített felhasználói (az adományok listája). |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
...
| **Az adatkezelés célja** | A hitelesítés feletti felügyelet eredményének rögzítése és a felügyeleti ügy vezetése abból a célból, hogy az Igazgatótanács megállapíthassa a hamis hitelesítést (a valóság bizonyításáról szóló szabályzat 4.4.1, 11., 11a. és 18. cikk). A 4.2.1 verzióig a felügyelő csak megerősíthette a hitelesítést; a gyanúnak nem volt hova rögzülnie, ezért nem is került kivizsgálásra. |
| --- | --- |
...
**16. sz. adatkezelési tevékenység — Beszerzési javaslat és részvétel a kollektív beszerzésben**

| **Az adatkezelés célja** | A közösség azon szükségleteinek megállapítása, amelyek a rendszeren belül nem elégíthetők ki, a kollektív beszerzésről szóló döntés érdekében (a KOLO rendszerről szóló szabályzat 51a. cikke), valamint az elhatározott beszerzés lebonyolítása — jelentkezés, a sorrend megállapítása és a rész átvétele. |
| --- | --- |
| **Az érintettek kategóriái** | Beszerzési javaslatot benyújtó felhasználók; közzétett beszerzésre jelentkező felhasználók. |
| **Az adatok kategóriái** | Beszerzési javaslat: álnév, a jószág megnevezése a megnevezésszótárból, a bevitel időpontja. Részvétel a beszerzésben: a jelentkezés ténye, a sorrendbeli hely, a felhasználó által bevitt átvételi nap, az átvételi kód, az átvétel időpontja. A sorrend megállapításához használt POEN-szám nem kerül újból gyűjtésre, hanem a 4. sz. tevékenységből kerül kiolvasásra. **Részvételi feltételek nem kerülnek megállapításra; a felhasználó státuszára, tevékenységére, vagyonára vagy körülményeire vonatkozó okiratok és nyilatkozatok nem kerülnek bekérésre és begyűjtésre.** |
| **Jogalap** | Szerződéses jogviszony teljesítése (a ZZPL 12. cikk (1) bekezdés 2. pontja) — a közjó elosztásában való részvétel része annak a jogviszonynak, amely alapján a felhasználó a rendszert használja. A javaslat benyújtása és a jelentkezés önkéntes; hiányuk nem jár következménnyel a felhasználó státuszára nézve. |
| **Címzettek / adatfeldolgozók** | **A szállító kizárólag az átvételi kódok jegyzékét kapja meg — álnevek és bármely személyre vonatkozó adat nélkül; a szállító nem címzettje személyes adatnak.** A javaslatok nyilvántartása összesítve, álnevek nélkül kerül közzétételre. A hitelesített felhasználók számára hozzáférhető a részt átvevő felhasználók jegyzéke, álnévvel és a sorrendbeli hellyel; a felhasználó bejegyzésében szereplő POEN-szám e jegyzékkel együtt nem kerül közzétételre. Infrastruktúra: Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), adatfeldolgozási szerződések alapján. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut, amely megfelelő védelmi szintet biztosít. A Vercel Inc. és a Neon Inc. egyesült államokbeli társaságok, ezért harmadik országból történő hozzáférés adminisztratív és technikai célból lehetséges, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
| **Megőrzési idő** | A beszerzési javaslat törlésre kerül, amikor a felhasználó másik megnevezést választ vagy a javaslatot eltávolítja, amikor a kiválasztott jószágmegnevezésre vonatkozó beszerzés lebonyolításra kerül, és legkésőbb a bevitelt követő tizenkét hónap elteltével. A részvételre és az átvételre vonatkozó adatok tíz évig kerülnek megőrzésre, a beszerzés számviteli dokumentációjával együtt. A felhasználói státusz megszűnésekor a fiók többi adatával együtt törlésre, illetve anonimizálásra kerülnek. |
| **Védelmi intézkedések** | Álnevesítés; a javaslat kizárólag a jószág megnevezését tartalmazza; a nyilvántartás összesített közzététele álnevek nélkül; a POEN-szám nem kerül közzétételre az átvevők jegyzéke mellett; a szállítónak csak a kód kerül továbbításra; a kód egyszer használatos és egyetlen jelentkezéshez kötött; TLS-titkosítás, nyugalmi állapotú titkosítás, hozzáférés-ellenőrzés. A sorrend megállapítása a nyilvánosan közzétett szabályok alkalmazása, és nem érinti a felhasználó státuszát, így a ZZPL 38. cikke szerinti automatizált döntéshozatal nem áll fenn; a megállapított sorrenddel szemben kifogás nyújtható be a ZZPL 37. cikke és a szabályzat 30. cikke alapján, amelyről ember dönt. |
| **Megjegyzés** | A javaslatok nyilvántartása azért kerül összesítve közzétételre, mert a beszerzés tárgyáról szóló döntést szolgálja, nem pedig azt, hogy ki mit kér. A részvételi feltételek éppen azért nem kerülnek megállapításra, hogy elkerülhető legyen a felhasználó tevékenységére és körülményeire vonatkozó adatok gyűjtése. |

**17. sz. adatkezelési tevékenység — A felhasználók közötti magánkommunikáció**

| **Az adatkezelés célja** | A felhasználók közötti négyszemközti beszélgetések lehetővé tétele, elsősorban a hirdetési felületen közzétett hirdetések kapcsán. |
| --- | --- |
| **Az érintettek kategóriái** | A beszélgetésben részt vevő felhasználók. |
| **Az adatok kategóriái** | A beszélgetésben részt vevő felek álnevei, a felhasználók által megadott üzenetek tartalma, a küldés ideje és az olvasottsági jelzés, valamint az a hirdetés, amely kapcsán a beszélgetés indult. |
| **Jogalap** | Szerződéses jogviszony teljesítése (ZZPL 12. cikk (1) bekezdés 2. pont) — a kommunikáció annak a jogviszonynak a tartalma, amely alapján a felhasználó a rendszert használja. |
| **Címzettek / adatfeldolgozók** | Kizárólag a beszélgetés másik fele. A kiskorú felhasználó szülője olvassa gyermekének nagykorú személlyel folytatott beszélgetését (11. sz. tevékenység). Az Alapítvány nem olvassa a beszélgetéseket; betekintése kizárólag a vitatott tartalom eltávolítása céljából van, a felhasználási feltételek 25. cikke alapján. Az új üzenet 120 karakteres részlete bekerül az elektronikus levélben küldött értesítésbe (Resend, Amerikai Egyesült Államok). Infrastruktúra: Vercel Inc. (tárhely, végrehajtás az Európai Unióban) és Neon Inc. (adatbázis, régió az Európai Unióban), adatfeldolgozási szerződés alapján. |
| **Harmadik országba történő továbbítás** | Az adatbázisban lévő adatok tekintetében nem — az alkalmazás és az adatbázis az Európai Unióban (frankfurti régió) fut. Az üzenetrészlet az elektronikus levélben küldött értesítéssel jut az Egyesült Államokba, az adatvédelmi szabályzat 9. cikke szerinti intézkedések mellett. |
