...
A leírás mechanikája. Az a felhasználó, aki egy elszámolási együttható mellett ír be ZRNO-t és egy másik mellett írja le, más számú POEN-t kap, mint amennyit a beírás alapjaként felhasznált — mindkét irányban, mivel az együttható az új POEN-bejegyzések beírásától nő és azok megsemmisítésétől csökken (6.4 szakasz). Négy elem bontja meg e különbség hozamként való minősítését: a leírással nyilvántartásba vett POEN-eknek nincs külső vagyoni értékük — nem konvertálhatók pénzzé, nem vihetők ki a rendszerből és nem tehetők pénzzé (a nem konvertálhatóság elve); az együttható változása nem szavatolt — a teljes közösség nyilvántartási állapotából ered, nem harmadik személyek erőfeszítéséből a befektetési szerződés értelmében; a saját beírás és leírás egyáltalán nem mozdítja el az együtthatót, így a tulajdonosnak sem eszköze, sem időpillanata nincs, amellyel a különbséget realizálhatná; nincs kibocsátó, aki az együttható növekedését ígérné, sem intézmény, amely kifizetné a különbséget. Ezen túlmenően a rendszer szerkezete olyan szerkezeti választást hoz létre, amely korlátozza a tisztán passzív tartást: az a tulajdonos, aki irányítási hasznot kíván, aktiválnia kell a ZRNO-t, amivel elveszíti a leírás lehetőségét; az a tulajdonos, aki elszámolási rugalmasságot kíván, nem szavazhat egyidejűleg.
...
Az együtthatót kizárólag a nyilvántartásba vett POEN-ek teljes számának változásai mozdítják el — felfelé és lefelé.

Valahányszor a protokoll új POEN-bejegyzéseket ír be — felhasználói hozzájárulás (adományok, pártfogás, működési hozzájárulás, hitelesítés), a körök és a szövetkezetek növekedése, szociális programok vagy alapítói hozzájárulás útján —, a képlet számlálója nő, függetlenül attól, kinek a bejegyzésében kerülnek nyilvántartásba az új POEN-ek. Ez felfelé mozdítja az elszámolási együtthatót.

Amikor a nyilvántartásba vett POEN-eket megsemmisítik — a felhasználói jogállás megszűnésével, a közösségi beszerzésben való felhasználás miatti megsemmisítéssel, a gyermektérben felbontott barátság miatti leírással vagy szabályzatban megállapított más jogalapon —, a számláló csökken. Ez lefelé mozdítja az elszámolási együtthatót. Az együttható tehát nem monoton, és nem eleve növekedésre rendelt.

A javak és szolgáltatások cseréje nem hat az együtthatóra, mert a meglévő POEN-eket osztja újra a teljes szám megváltoztatása nélkül.

A ZRNO beírása és leírása szintén nem mozdítja el az együtthatót, és ez magából a képletből következik, nem pedig olyan szabályból, amelyet módosítani lehetne. Beíráskor a nevező a beírt ZRNO-val csökken, de a számláló egyidejűleg csökken azokkal a POEN-ekkel, amelyek e beírással visszakerültek a protokollhoz és kikerültek a forgalomból — ez a szám pedig pontosan a beírt ZRNO és az érvényes együttható szorzata, így a hányados változatlan marad. Leíráskor mindkét tag ugyanolyan arányban nő. A ZRNO-tulajdonos saját eljárásával egyik irányban sem tudja elmozdítani a saját együtthatóját.

Mindezek a hatások a felhasználók rendszerbeli tevékenységének következményei. Egyetlen felhasználó sem ellenőrzi az együtthatót. Egyetlen intézmény sem ellenőrzi az együtthatót. Az együttható kiszámított érték, amely a rendszer valamennyi felhasználója nyilvántartásának teljes állapotából ered.
...
Az a felhasználó, aki korai szakaszban járul hozzá a rendszerhez — amikor az együttható alacsony —, kevesebb nyilvántartott POEN mellett ír be ZRNO-t, mint az a felhasználó, aki ugyanezt későbbi szakaszban, magasabb együttható mellett teszi. A korai résztvevő pozíciója ezzel azt a hozzájárulását tükrözi, amelyet abban a szakaszban tett, amikor a hozzájárulás a rendszer felállítása szempontjából a legértékesebb volt. Ez a közjóhoz való korábbi hozzájárulás elismerésének következménye, nem pedig pozíciószerzésre való ösztönzés: a beíráshoz szükséges POEN-ek számát a protokoll a nyilvántartás állapotából számítja ki, nem olyan döntés, amely a korai részvételt jutalmazná, és senki sem ígéri, hogy ez a szám később nagyobb lesz.

Az elszámolási időszakonkénti egy százalékos szabály (6.2 szakasz) korlátozza azt a sebességet, amellyel a rendelkezésre álló ZRNO-kat átveszik — még ha nagyszámú felhasználó egyidejűleg teljesíti is a beírás feltételeit, az időszakonkénti beírás teljes terjedelme valamennyi minősített felhasználó teljes állományának egy százalékára korlátozott. Ezzel megőrződik a későbbi résztvevők hozzáférése, az együttható pedig kevésbé érzékeny marad az új POEN-bejegyzések egyedi beírásaira, mert a rendelkezésre álló ZRNO-k száma nem merül ki hirtelen.
...
A protokoll nem veszi nyilvántartásba az alapítói hozzájárulást egyszerre, hanem a rendszer növekedéséhez köti — rögzített összegű lépésekben, a POEN-ek teljes számának halmozott növekedésével arányosan veszi nyilvántartásba. Ez tervezési döntés. Minden új POEN-bejegyzés beírása elmozdítja az elszámolási együtthatót (6.3 szakasz); a teljes összeg egyszerre történő nyilvántartásba vétele hirtelen együtthatóugrást eredményezne, míg a rendszer növekedéséhez való kötés azt eredményezi, hogy az együttható ugyanazt a szintet e növekedéssel arányosan éri el. A csatorna a növekedést követi, bármilyen is legyen annak üteme: ha a POEN-ek teljes száma hirtelen növekszik, a lépések ugyanolyan sebességgel kerülnek nyilvántartásba, amilyennel a növekedés bekövetkezett.

Mivel a lépés rögzített, egyetlen lépésnek az együtthatóra gyakorolt hatása csökken, ahogy a rendszer növekszik. Az összesítetten nyilvántartásba vett alapítói hozzájárulásnak a POEN-ek teljes számában képviselt hányada ettől eltérő mennyiség, és az nem csökken: mind a küszöbök, mind a lépés fix összegben van kifejezve, és az e csatornán nyilvántartásba vett POEN beleszámít a teljes számba, ezért az összesített alapítói hozzájárulás a csatorna teljes fennállása alatt a nyilvántartásba vett POEN-ek teljes számának megközelítőleg egyötöde és egynegyede közötti hányadát teszi ki — a lezáráskor megközelítőleg 24%-át. E hányad nem hordoz vagyoni jogot és nem jelent követelést; az alapítók köre zárt és nem bővíthető, a csatorna pedig a felső határ elérésével véglegesen lezárul.

A felső határ a rendszert megelőző hozzájárulás mértéke: az alapítók a megtervezésbe, az elkészítésbe, valamint a jogi és szervezeti előkészítésbe saját pénzeszközeiket és saját idejüket fektették, olyan időszakban, amelyben egyetlen nyilvántartási csatorna sem működött. Ez a munka az operatív hozzájárulás útján utólag sem vehető nyilvántartásba — e csatorna napi korlátja a nyilvántartásba vett POEN-ek teljes számának 10%-a, így amíg ez a szám nulla, a korlát is nulla.

Az alapítói munka eredménye — a rendszer szoftvere, protokollja és dokumentációja — a 3. fejezet szerinti licencek alatt kerül a közjóba: a szoftver az AGPL-3.0, a tartalom a CC BY-SA 4.0 licenc alatt. Az alapítók e munka alapján nem szereznek kizárólagos jogot az eredményre; az azonos feltételekkel minden személy számára hozzáférhető, és a licencek nem cserélhetők le korlátozóbbakra.
...
A rendszer elszámolási időszakonként a rendszerben nyilvántartott POEN-ek teljes számának 10 %-os korlátját alkalmazza arra az összegre, amely az adott időszakban a működési hozzájáruláson és a támogatási programokon keresztül együttesen nyilvántartásba vehető. Ez a korlát nem a POEN-ek teljes számának felső határa, hanem az a kulcs, amely szerint az időszak kibocsátása felosztásra kerül, ha az igényelt összegek összege meghaladja a korlátot: ilyenkor minden összeg arányosan csökken, a nyilvántartásba nem vett többlet pedig nem vihető át a következő időszakra. A POEN-ek teljes számát nem korlátozza előre meghatározott szám — a résztvevők számát és részvételük mértékét követi, mert minden bejegyzés egy meghatározott személy hozzájárulásához kötődik, és nem egyirányú, mert a bejegyzések érvénytelenítése csökkenti. Ez a paraméter a 10. fejezetben leírt irányítási folyamatokon keresztül változtatható. A jelentkezés, a végrehajtás és a hitelesítés eljárását a Szabályzat határozza meg.
...
A ZRNO-tulajdonosnak megvan a leírás lehetősége is — a szabad ZRNO visszaadása a rendelkezésre állók alapjába a folyó elszámolási együttható szerinti POEN-nyilvántartás mellett (6.2 szakasz). Ez a lehetőség nem ösztönző: a beíráskor felhasznált POEN-ek számához képesti különbség mindkét irányban keletkezik, senki sem ígéri, a saját beírás és leírás pedig nem mozdítja el az együtthatót (6.4 szakasz). Az esetleges haszon ezen felül a belső csere kapacitására korlátozódik, mert a POEN-ek nem hagyhatják el a rendszert. Ugyanakkor az irányítási funkció (aktív ZRNO) és az elszámolási rugalmasság (szabad ZRNO) közötti szerkezeti választás megakadályozza mindkét haszon egyidejű realizálását.
