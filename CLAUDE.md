...
- **🔴 Akti još nisu doneti.** Kod je pisan po nacrtima iz plana (verzije 4.1.0). Pre stupanja na snagu treba: sednica UO, nov red `PolitikaVerzija` i `PravilnikVerzija` (ponovna saglasnost), cirkularno obaveštenje kroz `SistemskoObavestenje` uz pravni osnov „Uslovi čl. 40, Politika čl. 16", i rok od **najmanje 15 dana** između objave i stupanja na snagu.
