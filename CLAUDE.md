...
- 🔴 **NORMATIVNI GAP — akti nisu dopunjeni.** `Pravilnik_4_2_0.md` čl. 40a i dalje propisuje **jednokratnih 1.000 POEN** za prvi oglas; lestvica od pet koraka, kapa od 5.000, prag od 1.000 POEN po transakciji i pojam „van kruga poznanstava" **nisu u aktima**. Kod je time ispred normative. Pre puštanja u rad ide dopuna čl. 40a i nova radnja obrade u DPIA/Radnjama obrade (`OglasUpit` je nova obrada podataka o ponašanju).
